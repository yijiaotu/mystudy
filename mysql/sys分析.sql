...
-- ----------------------------
DROP VIEW
IF EXISTS `x$host_summary_by_statement_latency`;

CREATE VIEW `x$host_summary_by_statement_latency` AS SELECT
...
IF (
 ...
 sum(
	`performance_schema`.`events_statements_summary_by_host_by_event_name`.`COUNT_STAR`
) AS `total`,
 sum(
	`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_TIMER_WAIT`
) AS `total_latency`,
 max(
	`performance_schema`.`events_statements_summary_by_host_by_event_name`.`MAX_TIMER_WAIT`
) AS `max_latency`,
 sum(
	`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_LOCK_TIME`
) AS `lock_latency`,
 sum(
	`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_SENT`
) AS `rows_sent`,
 sum(
	`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_EXAMINED`
) AS `rows_examined`,
 sum(
	`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_ROWS_AFFECTED`
) AS `rows_affected`,
 (
	sum(
		`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_NO_INDEX_USED`
	) + sum(
		`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_NO_GOOD_INDEX_USED`
	)
) AS `full_scans`
FROM
...
CREATE VIEW `host_summary` AS SELECT

IF (
	accounts. HOST IS NULL,
	'background',
	accounts. HOST
) AS HOST,
 ...
 sys.format_time (
	IFNULL(
		SUM(stmt.total_latency) / NULLIF(SUM(stmt.total), 0),
		0
	)
) AS statement_avg_latency,
...
-- ----------------------------
DROP VIEW
IF EXISTS `host_summary_by_file_io`;

CREATE VIEW `host_summary_by_file_io` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `host_summary_by_file_io_type`;

CREATE VIEW `host_summary_by_file_io_type` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `host_summary_by_stages`;

CREATE VIEW `host_summary_by_stages` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `host_summary_by_statement_latency`;

CREATE VIEW `host_summary_by_statement_latency` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `host_summary_by_statement_type`;

CREATE VIEW `host_summary_by_statement_type` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `innodb_buffer_stats_by_schema`;

CREATE VIEW `innodb_buffer_stats_by_schema` AS SELECT

IF (
	LOCATE('.', ibp.table_name) = 0,
	'InnoDB System',
	REPLACE (
		SUBSTRING_INDEX(ibp.table_name, '.', 1),
		'`',
		''
	)
) AS object_schema,
 ...
 COUNT(
	...
	IF (ibp.is_hashed = 'YES', 1, NULL)
) AS pages_hashed,
 COUNT(

	IF (ibp.is_old = 'YES', 1, NULL)
) AS pages_old,
 ROUND(
	SUM(ibp.number_records) / COUNT(DISTINCT ibp.index_name)
) AS rows_cached
FROM
...
-- ----------------------------
DROP VIEW
IF EXISTS `innodb_buffer_stats_by_table`;

CREATE VIEW `innodb_buffer_stats_by_table` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `innodb_lock_waits`;

CREATE VIEW `innodb_lock_waits` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `io_by_thread_by_latency`;

CREATE VIEW `io_by_thread_by_latency` AS SELECT

IF (
	processlist_id IS NULL,
...
-- ----------------------------
DROP VIEW
IF EXISTS `io_global_by_file_by_bytes`;

CREATE VIEW `io_global_by_file_by_bytes` AS SELECT
	sys.format_path (file_name) AS file,
	count_read,
	sys.format_bytes (sum_number_of_bytes_read) AS total_read,
	sys.format_bytes (
		IFNULL(
			sum_number_of_bytes_read / NULLIF(count_read, 0),
			0
		)
	) AS avg_read,
	count_write,
	...
	sys.format_bytes (
		IFNULL(
			sum_number_of_bytes_write / NULLIF(count_write, 0),
			0.00
		)
	) AS avg_write,
	sys.format_bytes (
	...
	IFNULL(
		ROUND(
			100 - (
				(
					sum_number_of_bytes_read / NULLIF(
						(
							sum_number_of_bytes_read + sum_number_of_bytes_write
						),
						0
...
-- ----------------------------
DROP VIEW
IF EXISTS `io_global_by_file_by_latency`;

CREATE VIEW `io_global_by_file_by_latency` AS SELECT
	sys.format_path (file_name) AS file,
	count_star AS total,
	sys.format_time (sum_timer_wait) AS total_latency,
	count_read,
...
-- ----------------------------
DROP VIEW
IF EXISTS `io_global_by_wait_by_bytes`;

CREATE VIEW `io_global_by_wait_by_bytes` AS SELECT
	SUBSTRING_INDEX(event_name, '/', - 2) event_name,
	count_star AS total,
	sys.format_time (sum_timer_wait) AS total_latency,
...
AND count_star > 0
ORDER BY
	sum_number_of_bytes_write + sum_number_of_bytes_read DESC;

-- ----------------------------
-- View structure for io_global_by_wait_by_latency
-- ----------------------------
DROP VIEW
IF EXISTS `io_global_by_wait_by_latency`;

CREATE VIEW `io_global_by_wait_by_latency` AS SELECT
	SUBSTRING_INDEX(event_name, '/', - 2) AS event_name,
	count_star AS total,
	sys.format_time (sum_timer_wait) AS total_latency,
	sys.format_time (avg_timer_wait) AS avg_latency,
	sys.format_time (max_timer_wait) AS max_latency,
...
-- ----------------------------
DROP VIEW
IF EXISTS `latest_file_io`;

CREATE VIEW `latest_file_io` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `memory_by_host_by_current_bytes`;

CREATE VIEW `memory_by_host_by_current_bytes` AS SELECT
...
) AS current_allocated,
 sys.format_bytes (
	IFNULL(
		SUM(
			current_number_of_bytes_used
		) / NULLIF(SUM(current_count_used), 0),
		0
	)
) AS current_avg_alloc,
 sys.format_bytes (
	MAX(
		current_number_of_bytes_used
	)
...
-- ----------------------------
DROP VIEW
IF EXISTS `memory_by_thread_by_current_bytes`;

CREATE VIEW `memory_by_thread_by_current_bytes` AS SELECT
	thread_id,

IF (
	t. NAME = 'thread/sql/one_connection',
	CONCAT(
		t.processlist_user,
		'@',
		t.processlist_host
 ...
 sys.format_bytes (
	SUM(
		mt.current_number_of_bytes_used
	)
) AS current_allocated,
 sys.format_bytes (
	IFNULL(
 ...
 sys.format_bytes (
	SUM(
		mt.sum_number_of_bytes_alloc
	)
) AS total_allocated
FROM
	PERFORMANCE_SCHEMA .memory_summary_by_thread_by_event_name AS mt
...
-- ----------------------------
DROP VIEW
IF EXISTS `memory_by_user_by_current_bytes`;

CREATE VIEW `memory_by_user_by_current_bytes` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `memory_global_by_current_bytes`;

CREATE VIEW `memory_global_by_current_bytes` AS SELECT
	event_name,
	...
	sys.format_bytes (
		IFNULL(
			current_number_of_bytes_used / NULLIF(current_count_used, 0),
			0
		)
	) AS current_avg_alloc,
	...
	sys.format_bytes (
		IFNULL(
			high_number_of_bytes_used / NULLIF(high_count_used, 0),
			0
		)
	) AS high_avg_alloc
FROM
...
-- ----------------------------
DROP VIEW
IF EXISTS `memory_global_total`;

CREATE VIEW `memory_global_total` AS SELECT
	sys.format_bytes (
		SUM(
			CURRENT_NUMBER_OF_BYTES_USED
		)
...
UNION ALL
	(
		SELECT
			...
			SUM(SUM_NUMBER_OF_BYTES_ALLOC) AS Variable_value,
			'Performance Schema' AS Type,
...
LEFT JOIN PERFORMANCE_SCHEMA .session_connect_attrs AS conattr_pid ON conattr_pid.processlist_id = pps.processlist_id
AND conattr_pid.attr_name = '_pid'
LEFT JOIN PERFORMANCE_SCHEMA .session_connect_attrs AS conattr_progname ON conattr_progname.processlist_id = pps.processlist_id
AND conattr_progname.attr_name = 'program_name'
ORDER BY
	pps.processlist_time DESC,
...
-- ----------------------------
DROP VIEW
IF EXISTS `ps_check_lost_instrumentation`;

CREATE VIEW `ps_check_lost_instrumentation` AS SELECT
	variable_name,
	variable_value
FROM
	PERFORMANCE_SCHEMA .global_status
WHERE
	variable_name LIKE 'perf%lost'
...
-- ----------------------------
DROP VIEW
IF EXISTS `schema_auto_increment_columns`;

CREATE VIEW `schema_auto_increment_columns` AS SELECT
	TABLE_SCHEMA,
	TABLE_NAME,
	COLUMN_NAME,
	DATA_TYPE,
...
-- ----------------------------
DROP VIEW
IF EXISTS `schema_index_statistics`;

CREATE VIEW `schema_index_statistics` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `schema_object_overview`;
...
-- ----------------------------
DROP VIEW
IF EXISTS `schema_redundant_indexes`;

CREATE VIEW `schema_redundant_indexes` AS SELECT
...
INNER JOIN x$schema_flattened_keys AS dominant_keys USING (TABLE_SCHEMA, TABLE_NAME)
WHERE
...
-- ----------------------------
DROP VIEW
IF EXISTS `schema_tables_with_full_table_scans`;

CREATE VIEW `schema_tables_with_full_table_scans` AS SELECT
	object_schema,
	object_name,
...
-- ----------------------------
DROP VIEW
IF EXISTS `schema_table_lock_waits`;

CREATE VIEW `schema_table_lock_waits` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `schema_table_statistics`;

CREATE VIEW `schema_table_statistics` AS SELECT
...
LEFT JOIN x$ps_schema_table_statistics_io AS fsbi ON pst.object_schema = fsbi.table_schema
...
-- ----------------------------
DROP VIEW
IF EXISTS `schema_table_statistics_with_buffer`;

CREATE VIEW `schema_table_statistics_with_buffer` AS SELECT
	pst.object_schema AS table_schema,
	pst.object_name AS table_name,
	pst.count_fetch AS rows_fetched,
	sys.format_time (pst.sum_timer_fetch) AS fetch_latency,
...
LEFT JOIN x$ps_schema_table_statistics_io AS fsbi ON pst.object_schema = fsbi.table_schema
AND pst.object_name = fsbi.table_name
LEFT JOIN sys.x$innodb_buffer_stats_by_table AS ibp ON pst.object_schema = ibp.object_schema
...
-- ----------------------------
DROP VIEW
IF EXISTS `schema_unused_indexes`;

CREATE VIEW `schema_unused_indexes` AS SELECT
	object_schema,
	object_name,
	index_name
FROM
...
-- ----------------------------
DROP VIEW
IF EXISTS `session_ssl_status`;

CREATE VIEW `session_ssl_status` AS SELECT
	sslver.thread_id,
...
LEFT JOIN PERFORMANCE_SCHEMA .status_by_thread sslcip ON (
	sslcip.thread_id = sslver.thread_id
	AND sslcip.variable_name = 'Ssl_cipher'
)
LEFT JOIN PERFORMANCE_SCHEMA .status_by_thread sslreuse ON (
	sslreuse.thread_id = sslver.thread_id
...
-- ----------------------------
DROP VIEW
IF EXISTS `statements_with_errors_or_warnings`;

CREATE VIEW `statements_with_errors_or_warnings` AS SELECT
	sys.format_statement (DIGEST_TEXT) AS QUERY,
	SCHEMA_NAME AS db,
	COUNT_STAR AS exec_count,
	SUM_ERRORS AS ERRORS,
	IFNULL(
		SUM_ERRORS / NULLIF(COUNT_STAR, 0),
		0
	) * 100 AS error_pct,
	SUM_WARNINGS AS WARNINGS,
	IFNULL(
		SUM_WARNINGS / NULLIF(COUNT_STAR, 0),
		0
	) * 100 AS warning_pct,
...
-- ----------------------------
DROP VIEW
IF EXISTS `statements_with_full_table_scans`;

CREATE VIEW `statements_with_full_table_scans` AS SELECT
	sys.format_statement (DIGEST_TEXT) AS QUERY,
	SCHEMA_NAME AS db,
	COUNT_STAR AS exec_count,
	sys.format_time (SUM_TIMER_WAIT) AS total_latency,
	...
	ROUND(
		IFNULL(
			SUM_NO_INDEX_USED / NULLIF(COUNT_STAR, 0),
			0
		) * 100
...
-- ----------------------------
DROP VIEW
IF EXISTS `statements_with_runtimes_in_95th_percentile`;

CREATE VIEW `statements_with_runtimes_in_95th_percentile` AS SELECT
	sys.format_statement (DIGEST_TEXT) AS QUERY,
	SCHEMA_NAME AS db,
...
IF (
 ...
 ROUND(
	IFNULL(
		SUM_ROWS_SENT / NULLIF(COUNT_STAR, 0),
		0
	)
) AS rows_sent_avg,
 SUM_ROWS_EXAMINED AS rows_examined,
 ROUND(
	IFNULL(
		SUM_ROWS_EXAMINED / NULLIF(COUNT_STAR, 0),
		0
	)
) AS rows_examined_avg,
 FIRST_SEEN AS first_seen,
...
JOIN sys.x$ps_digest_95th_percentile_by_avg_us AS top_percentile ON ROUND(
	stmts.avg_timer_wait / 1000000
) >= top_percentile.avg_us
ORDER BY
	AVG_TIMER_WAIT DESC;
...
-- ----------------------------
DROP VIEW
IF EXISTS `statements_with_sorting`;

CREATE VIEW `statements_with_sorting` AS SELECT
	sys.format_statement (DIGEST_TEXT) AS QUERY,
	SCHEMA_NAME db,
	COUNT_STAR AS exec_count,
	sys.format_time (SUM_TIMER_WAIT) AS total_latency,
	...
	ROUND(
		IFNULL(
			SUM_SORT_MERGE_PASSES / NULLIF(COUNT_STAR, 0),
			0
		)
	) AS avg_sort_merges,
	...
	ROUND(
		IFNULL(
			SUM_SORT_ROWS / NULLIF(COUNT_STAR, 0),
			0
		)
	) AS avg_rows_sorted,
	FIRST_SEEN AS first_seen,
...
-- ----------------------------
DROP VIEW
IF EXISTS `statements_with_temp_tables`;

CREATE VIEW `statements_with_temp_tables` AS SELECT
	sys.format_statement (DIGEST_TEXT) AS QUERY,
	SCHEMA_NAME AS db,
	COUNT_STAR AS exec_count,
	sys.format_time (SUM_TIMER_WAIT) AS total_latency,
	...
	ROUND(
		IFNULL(
			SUM_CREATED_TMP_TABLES / NULLIF(COUNT_STAR, 0),
			0
		)
...
-- ----------------------------
DROP VIEW
IF EXISTS `statement_analysis`;

CREATE VIEW `statement_analysis` AS SELECT
	sys.format_statement (DIGEST_TEXT) AS QUERY,
	SCHEMA_NAME AS db,
...
IF (
 ...
 ROUND(
	IFNULL(
		SUM_ROWS_AFFECTED / NULLIF(COUNT_STAR, 0),
		0
	)
...
-- ----------------------------
DROP VIEW
IF EXISTS `user_summary`;

CREATE VIEW `user_summary` AS SELECT

IF (
	accounts. USER IS NULL,
	'background',
	accounts. USER
) AS USER,
 SUM(stmt.total) AS statements,
...
FROM
	PERFORMANCE_SCHEMA .accounts
LEFT JOIN sys.x$user_summary_by_statement_latency AS stmt ON
IF (
	accounts. USER IS NULL,
	'background',
	accounts. USER
) = stmt. USER
LEFT JOIN sys.x$user_summary_by_file_io AS io ON
IF (
	accounts. USER IS NULL,
	'background',
	accounts. USER
) = io. USER
LEFT JOIN sys.x$memory_by_user_by_current_bytes mem ON
IF (
	accounts. USER IS NULL,
	'background',
	accounts. USER
...
ORDER BY
	SUM(stmt.total_latency) DESC;

-- ----------------------------
-- View structure for user_summary_by_file_io
-- ----------------------------
DROP VIEW
IF EXISTS `user_summary_by_file_io`;

CREATE VIEW `user_summary_by_file_io` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `user_summary_by_file_io_type`;

CREATE VIEW `user_summary_by_file_io_type` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `user_summary_by_stages`;

CREATE VIEW `user_summary_by_stages` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `user_summary_by_statement_latency`;

CREATE VIEW `user_summary_by_statement_latency` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `user_summary_by_statement_type`;

CREATE VIEW `user_summary_by_statement_type` AS SELECT
...
CREATE ALGORITHM = UNDEFINED  SQL SECURITY INVOKER VIEW `version` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `waits_by_host_by_latency`;

CREATE VIEW `waits_by_host_by_latency` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `waits_by_user_by_latency`;

CREATE VIEW `waits_by_user_by_latency` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `waits_global_by_latency`;

CREATE VIEW `waits_global_by_latency` AS SELECT
	event_name AS EVENT,
	count_star AS total,
	sys.format_time (sum_timer_wait) AS total_latency,
	sys.format_time (avg_timer_wait) AS avg_latency,
...
-- ----------------------------
DROP VIEW
IF EXISTS `wait_classes_global_by_avg_latency`;

CREATE VIEW `wait_classes_global_by_avg_latency` AS SELECT
	SUBSTRING_INDEX(event_name, '/', 3) AS event_class,
	SUM(COUNT_STAR) AS total,
	sys.format_time (
		CAST(
			SUM(sum_timer_wait) AS UNSIGNED
		)
	) AS total_latency,
	sys.format_time (MIN(min_timer_wait)) AS min_latency,
	sys.format_time (
		IFNULL(
			SUM(sum_timer_wait) / NULLIF(SUM(COUNT_STAR), 0),
			0
		)
	) AS avg_latency,
	sys.format_time (
		CAST(
			MAX(max_timer_wait) AS UNSIGNED
		)
	) AS max_latency
FROM
	PERFORMANCE_SCHEMA .events_waits_summary_global_by_event_name
...
-- ----------------------------
DROP VIEW
IF EXISTS `wait_classes_global_by_latency`;

CREATE VIEW `wait_classes_global_by_latency` AS SELECT
	SUBSTRING_INDEX(event_name, '/', 3) AS event_class,
	SUM(COUNT_STAR) AS total,
	sys.format_time (SUM(sum_timer_wait)) AS total_latency,
	sys.format_time (MIN(min_timer_wait)) min_latency,
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$host_summary`;

CREATE VIEW `x$host_summary` AS SELECT
...
IF (
 ...
 (
	sum(`stmt`.`total_latency`) / sum(`stmt`.`total`)
) AS `statement_avg_latency`,
 sum(`stmt`.`full_scans`) AS `table_scans`,
 sum(`io`.`ios`) AS `file_ios`,
 sum(`io`.`io_latency`) AS `file_io_latency`,
 sum(
	`performance_schema`.`accounts`.`CURRENT_CONNECTIONS`
) AS `current_connections`,
 sum(
	`performance_schema`.`accounts`.`TOTAL_CONNECTIONS`
) AS `total_connections`,
 count(
	DISTINCT `performance_schema`.`accounts`.`USER`
) AS `unique_users`,
...
FROM
	(
		(
			(
				`performance_schema`.`accounts`
				JOIN `sys`.`x$host_summary_by_statement_latency` `stmt` ON (
					(
						`performance_schema`.`accounts`.`HOST` = `stmt`.`host`
					)
				)
			)
			JOIN `sys`.`x$host_summary_by_file_io` `io` ON (
				(
					`performance_schema`.`accounts`.`HOST` = `io`.`host`
				)
			)
		)
		JOIN `sys`.`x$memory_by_host_by_current_bytes` `mem` ON (
			(
				`performance_schema`.`accounts`.`HOST` = `mem`.`host`
			)
		)
	)
GROUP BY
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$host_summary_by_file_io`;

CREATE VIEW `x$host_summary_by_file_io` AS SELECT
...
IF (
 ...
 sum(
	`performance_schema`.`events_waits_summary_by_host_by_event_name`.`COUNT_STAR`
) AS `ios`,
 sum(
	`performance_schema`.`events_waits_summary_by_host_by_event_name`.`SUM_TIMER_WAIT`
) AS `io_latency`
FROM
	`performance_schema`.`events_waits_summary_by_host_by_event_name`
WHERE
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$host_summary_by_file_io_type`;

CREATE VIEW `x$host_summary_by_file_io_type` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$host_summary_by_stages`;

CREATE VIEW `x$host_summary_by_stages` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$host_summary_by_statement_type`;

CREATE VIEW `x$host_summary_by_statement_type` AS SELECT
...
IF (
 ...
 (
	`performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_NO_INDEX_USED` + `performance_schema`.`events_statements_summary_by_host_by_event_name`.`SUM_NO_GOOD_INDEX_USED`
) AS `full_scans`
FROM
	`performance_schema`.`events_statements_summary_by_host_by_event_name`
WHERE
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$innodb_buffer_stats_by_schema`;

CREATE VIEW `x$innodb_buffer_stats_by_schema` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$innodb_buffer_stats_by_table`;

CREATE VIEW `x$innodb_buffer_stats_by_table` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$innodb_lock_waits`;

CREATE VIEW `x$innodb_lock_waits` AS SELECT
	`r`.`trx_wait_started` AS `wait_started`,
	timediff(
		now(),
		`r`.`trx_wait_started`
...
FROM
	(
		(
			...
			JOIN `information_schema`.`innodb_locks` `bl` ON (
				(
					`bl`.`lock_id` = `w`.`blocking_lock_id`
				)
			)
		)
		JOIN `information_schema`.`innodb_locks` `rl` ON (
			(
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$io_by_thread_by_latency`;

CREATE VIEW `x$io_by_thread_by_latency` AS SELECT
...
IF (
 ...
 sum(
	`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`COUNT_STAR`
) AS `total`,
 sum(
	`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`SUM_TIMER_WAIT`
) AS `total_latency`,
 min(
	`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`MIN_TIMER_WAIT`
) AS `min_latency`,
 avg(
	`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`AVG_TIMER_WAIT`
) AS `avg_latency`,
 max(
	`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`MAX_TIMER_WAIT`
) AS `max_latency`,
...
FROM
	(
		`performance_schema`.`events_waits_summary_by_thread_by_event_name`
		LEFT JOIN `performance_schema`.`threads` ON (
			(
...
GROUP BY
	`performance_schema`.`events_waits_summary_by_thread_by_event_name`.`THREAD_ID`,
	`performance_schema`.`threads`.`PROCESSLIST_ID`,
	`user`
ORDER BY
	sum(
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$io_global_by_file_by_bytes`;

CREATE VIEW `x$io_global_by_file_by_bytes` AS SELECT
	...
	ifnull(
		(
			`performance_schema`.`file_summary_by_instance`.`SUM_NUMBER_OF_BYTES_READ` / nullif(
				`performance_schema`.`file_summary_by_instance`.`COUNT_READ`,
				0
			)
		),
		0
	...
	ifnull(
		(
			`performance_schema`.`file_summary_by_instance`.`SUM_NUMBER_OF_BYTES_WRITE` / nullif(
				`performance_schema`.`file_summary_by_instance`.`COUNT_WRITE`,
				0
			)
		),
		0.00
	...
	(
		`performance_schema`.`file_summary_by_instance`.`SUM_NUMBER_OF_BYTES_READ` + `performance_schema`.`file_summary_by_instance`.`SUM_NUMBER_OF_BYTES_WRITE`
	) AS `total`,
	ifnull(
		round(
			(
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$io_global_by_file_by_latency`;

CREATE VIEW `x$io_global_by_file_by_latency` AS SELECT
	`performance_schema`.`file_summary_by_instance`.`FILE_NAME` AS `file`,
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$io_global_by_wait_by_bytes`;

CREATE VIEW `x$io_global_by_wait_by_bytes` AS SELECT
	substring_index(
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$io_global_by_wait_by_latency`;

CREATE VIEW `x$io_global_by_wait_by_latency` AS SELECT
	substring_index(
		`performance_schema`.`file_summary_by_event_name`.`EVENT_NAME`,
		'/' ,- (2)
	) AS `event_name`,
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$latest_file_io`;

CREATE VIEW `x$latest_file_io` AS SELECT
...
FROM
	(
		(
			`performance_schema`.`events_waits_history_long`
			JOIN `performance_schema`.`threads` ON (
				(
					`performance_schema`.`events_waits_history_long`.`THREAD_ID` = `performance_schema`.`threads`.`THREAD_ID`
				)
			)
		)
		LEFT JOIN `information_schema`.`processlist` ON (
			(
				`performance_schema`.`threads`.`PROCESSLIST_ID` = `information_schema`.`processlist`.`ID`
			)
		)
	)
WHERE
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$memory_by_host_by_current_bytes`;

CREATE VIEW `x$memory_by_host_by_current_bytes` AS SELECT
...
IF (
 ...
 sum(
	`performance_schema`.`memory_summary_by_host_by_event_name`.`SUM_NUMBER_OF_BYTES_ALLOC`
) AS `total_allocated`
FROM
	`performance_schema`.`memory_summary_by_host_by_event_name`
GROUP BY
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$memory_by_thread_by_current_bytes`;

CREATE VIEW `x$memory_by_thread_by_current_bytes` AS SELECT
...
FROM
	(
		...
		JOIN `performance_schema`.`threads` `t` ON (
			(
				`mt`.`THREAD_ID` = `t`.`THREAD_ID`
			)
		)
	)
GROUP BY
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$memory_by_user_by_current_bytes`;

CREATE VIEW `x$memory_by_user_by_current_bytes` AS SELECT
...
IF (
 ...
 sum(
	`performance_schema`.`memory_summary_by_user_by_event_name`.`CURRENT_COUNT_USED`
) AS `current_count_used`,
 sum(
	`performance_schema`.`memory_summary_by_user_by_event_name`.`CURRENT_NUMBER_OF_BYTES_USED`
) AS `current_allocated`,
 ifnull(
	(
		sum(
 ...
 sum(
	`performance_schema`.`memory_summary_by_user_by_event_name`.`SUM_NUMBER_OF_BYTES_ALLOC`
) AS `total_allocated`
FROM
	`performance_schema`.`memory_summary_by_user_by_event_name`
GROUP BY
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$memory_global_by_current_bytes`;

CREATE VIEW `x$memory_global_by_current_bytes` AS SELECT
	...
	ifnull(
		(
			`performance_schema`.`memory_summary_global_by_event_name`.`CURRENT_NUMBER_OF_BYTES_USED` / nullif(
				`performance_schema`.`memory_summary_global_by_event_name`.`CURRENT_COUNT_USED`,
				0
			)
		),
		0
	...
	ifnull(
		(
			`performance_schema`.`memory_summary_global_by_event_name`.`HIGH_NUMBER_OF_BYTES_USED` / nullif(
				`performance_schema`.`memory_summary_global_by_event_name`.`HIGH_COUNT_USED`,
				0
			)
		),
		0
...
ORDER BY
	`performance_schema`.`memory_summary_global_by_event_name`.`CURRENT_NUMBER_OF_BYTES_USED` DESC;

-- ----------------------------
-- View structure for x$memory_global_total
-- ----------------------------
DROP VIEW
IF EXISTS `x$memory_global_total`;

CREATE VIEW `x$memory_global_total` AS SELECT
	sum(
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$processlist`;

CREATE VIEW `x$processlist` AS SELECT
	`pps`.`THREAD_ID` AS `thd_id`,
	`pps`.`PROCESSLIST_ID` AS `conn_id`,
...
IF (
	(
		isnull(`ewc`.`END_EVENT_ID`)
		AND (
			`ewc`.`EVENT_NAME` IS NOT NULL
		)
	),
	'Still Waiting',
	`ewc`.`TIMER_WAIT`
...
FROM
	(
					...
					(
						(
							(
								...
								LEFT JOIN `performance_schema`.`events_waits_current` `ewc` ON (
									(
										`pps`.`THREAD_ID` = `ewc`.`THREAD_ID`
									)
								)
							)
							LEFT JOIN `performance_schema`.`events_stages_current` `estc` ON (
								(
									`pps`.`THREAD_ID` = `estc`.`THREAD_ID`
								)
							)
						)
						LEFT JOIN `performance_schema`.`events_statements_current` `esc` ON (
							(
								`pps`.`THREAD_ID` = `esc`.`THREAD_ID`
							)
						)
					)
					LEFT JOIN `performance_schema`.`events_transactions_current` `etc` ON (
						(
							`pps`.`THREAD_ID` = `etc`.`THREAD_ID`
						)
					)
				)
				LEFT JOIN `sys`.`x$memory_by_thread_by_current_bytes` `mem` ON (
					(
						`pps`.`THREAD_ID` = `mem`.`thread_id`
					)
				)
			)
		...
		LEFT JOIN `performance_schema`.`session_connect_attrs` `conattr_progname` ON (
			(
				(
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$ps_digest_95th_percentile_by_avg_us`;

CREATE VIEW `x$ps_digest_95th_percentile_by_avg_us` AS SELECT
	`s2`.`avg_us` AS `avg_us`,
	ifnull(
		(
			sum(`s1`.`cnt`) / nullif(
...
FROM
	(
		...
		JOIN `sys`.`x$ps_digest_avg_latency_distribution` `s2` ON (
			(
				`s1`.`avg_us` <= `s2`.`avg_us`
			)
		)
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$ps_digest_avg_latency_distribution`;

CREATE VIEW `x$ps_digest_avg_latency_distribution` AS SELECT
	count(0) AS `cnt`,
	round(
		(
			`performance_schema`.`events_statements_summary_by_digest`.`AVG_TIMER_WAIT` / 1000000
		),
		0
	) AS `avg_us`
FROM
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$ps_schema_table_statistics_io`;

CREATE VIEW `x$ps_schema_table_statistics_io` AS SELECT
	...
	) AS `sum_number_of_bytes_read`,
	sum(
		`performance_schema`.`file_summary_by_instance`.`SUM_TIMER_READ`
	) AS `sum_timer_read`,
	sum(
		`performance_schema`.`file_summary_by_instance`.`COUNT_WRITE`
	) AS `count_write`,
	...
	) AS `sum_number_of_bytes_write`,
	sum(
		`performance_schema`.`file_summary_by_instance`.`SUM_TIMER_WRITE`
	) AS `sum_timer_write`,
	sum(
		`performance_schema`.`file_summary_by_instance`.`COUNT_MISC`
	) AS `count_misc`,
	sum(
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$schema_flattened_keys`;

CREATE VIEW `x$schema_flattened_keys` AS SELECT
	...
	group_concat(
		...
		ORDER BY
			`information_schema`.`statistics`.`SEQ_IN_INDEX` ASC SEPARATOR ','
	) AS `index_columns`
FROM
	`information_schema`.`statistics`
WHERE
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$schema_index_statistics`;

CREATE VIEW `x$schema_index_statistics` AS SELECT
...
ORDER BY
	`performance_schema`.`table_io_waits_summary_by_index_usage`.`SUM_TIMER_WAIT` DESC;

-- ----------------------------
-- View structure for x$schema_tables_with_full_table_scans
-- ----------------------------
DROP VIEW
IF EXISTS `x$schema_tables_with_full_table_scans`;

CREATE VIEW `x$schema_tables_with_full_table_scans` AS SELECT
...
WHERE
	(
		isnull(
			`performance_schema`.`table_io_waits_summary_by_index_usage`.`INDEX_NAME`
		)
		AND (
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$schema_table_lock_waits`;

CREATE VIEW `x$schema_table_lock_waits` AS SELECT
	`g`.`OBJECT_SCHEMA` AS `object_schema`,
	`g`.`OBJECT_NAME` AS `object_name`,
	`pt`.`THREAD_ID` AS `waiting_thread_id`,
	`pt`.`PROCESSLIST_ID` AS `waiting_pid`,
					...
					(
						...
						JOIN `performance_schema`.`metadata_locks` `p` ON (
							(
								...
								AND (
									`g`.`OBJECT_NAME` = `p`.`OBJECT_NAME`
								)
								AND (
									`g`.`LOCK_STATUS` = 'GRANTED'
								)
								AND (
									`p`.`LOCK_STATUS` = 'PENDING'
								)
							)
						)
					)
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$schema_table_statistics`;

CREATE VIEW `x$schema_table_statistics` AS SELECT
	`pst`.`OBJECT_SCHEMA` AS `table_schema`,
	`pst`.`OBJECT_NAME` AS `table_name`,
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$schema_table_statistics_with_buffer`;

CREATE VIEW `x$schema_table_statistics_with_buffer` AS SELECT
	`pst`.`OBJECT_SCHEMA` AS `table_schema`,
	`pst`.`OBJECT_NAME` AS `table_name`,
	`pst`.`COUNT_FETCH` AS `rows_fetched`,
	`pst`.`SUM_TIMER_FETCH` AS `fetch_latency`,
	...
	(
		`ibp`.`allocated` - `ibp`.`data`
	) AS `innodb_buffer_free`,
	`ibp`.`pages` AS `innodb_buffer_pages`,
	`ibp`.`pages_hashed` AS `innodb_buffer_pages_hashed`,
	`ibp`.`pages_old` AS `innodb_buffer_pages_old`,
	`ibp`.`rows_cached` AS `innodb_buffer_rows_cached`
...
WHERE
	(
		(
			`x$processlist`.`conn_id` IS NOT NULL
		)
		AND (
			`x$processlist`.`command` <> 'Daemon'
		)
	);
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$statements_with_errors_or_warnings`;

CREATE VIEW `x$statements_with_errors_or_warnings` AS SELECT
	...
	(
		ifnull(
			(
				`performance_schema`.`events_statements_summary_by_digest`.`SUM_ERRORS` / nullif(
	...
	(
		ifnull(
			(
				`performance_schema`.`events_statements_summary_by_digest`.`SUM_WARNINGS` / nullif(
					`performance_schema`.`events_statements_summary_by_digest`.`COUNT_STAR`,
					0
				)
			),
...
ORDER BY
	`performance_schema`.`events_statements_summary_by_digest`.`SUM_ERRORS` DESC,
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$statements_with_full_table_scans`;

CREATE VIEW `x$statements_with_full_table_scans` AS SELECT
	`performance_schema`.`events_statements_summary_by_digest`.`DIGEST_TEXT` AS `query`,
	`performance_schema`.`events_statements_summary_by_digest`.`SCHEMA_NAME` AS `db`,
	`performance_schema`.`events_statements_summary_by_digest`.`COUNT_STAR` AS `exec_count`,
	...
	round(
		(
			ifnull(
				(
					`performance_schema`.`events_statements_summary_by_digest`.`SUM_NO_INDEX_USED` / nullif(
						`performance_schema`.`events_statements_summary_by_digest`.`COUNT_STAR`,
						0
					)
				),
	...
	round(
		(
			`performance_schema`.`events_statements_summary_by_digest`.`SUM_ROWS_SENT` / `performance_schema`.`events_statements_summary_by_digest`.`COUNT_STAR`
		),
		0
	) AS `rows_sent_avg`,
	round(
		(
			`performance_schema`.`events_statements_summary_by_digest`.`SUM_ROWS_EXAMINED` / `performance_schema`.`events_statements_summary_by_digest`.`COUNT_STAR`
		),
		0
	) AS `rows_examined_avg`,
	`performance_schema`.`events_statements_summary_by_digest`.`FIRST_SEEN` AS `first_seen`,
...
WHERE
	(
		...
		AND (
			NOT (
				(
					`performance_schema`.`events_statements_summary_by_digest`.`DIGEST_TEXT` LIKE 'SHOW%'
				)
			)
		)
	)
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$statements_with_runtimes_in_95th_percentile`;

CREATE VIEW `x$statements_with_runtimes_in_95th_percentile` AS SELECT
...
IF (
	(
		(
			`stmts`.`SUM_NO_GOOD_INDEX_USED` > 0
		)
		OR (
			`stmts`.`SUM_NO_INDEX_USED` > 0
		)
	),
	'*',
	''
 ...
 round(
	ifnull(
		(
			`stmts`.`SUM_ROWS_SENT` / nullif(`stmts`.`COUNT_STAR`, 0)
		),
		0
	),
	0
 ...
 round(
	ifnull(
		(
			`stmts`.`SUM_ROWS_EXAMINED` / nullif(`stmts`.`COUNT_STAR`, 0)
		),
		0
	),
	0
...
FROM
	(
		`performance_schema`.`events_statements_summary_by_digest` `stmts`
		JOIN `sys`.`x$ps_digest_95th_percentile_by_avg_us` `top_percentile` ON (
			(
				round(
					(
						`stmts`.`AVG_TIMER_WAIT` / 1000000
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$statements_with_sorting`;

CREATE VIEW `x$statements_with_sorting` AS SELECT
	`performance_schema`.`events_statements_summary_by_digest`.`DIGEST_TEXT` AS `query`,
	`performance_schema`.`events_statements_summary_by_digest`.`SCHEMA_NAME` AS `db`,
	`performance_schema`.`events_statements_summary_by_digest`.`COUNT_STAR` AS `exec_count`,
	`performance_schema`.`events_statements_summary_by_digest`.`SUM_TIMER_WAIT` AS `total_latency`,
	...
	round(
		ifnull(
			(
				`performance_schema`.`events_statements_summary_by_digest`.`SUM_SORT_MERGE_PASSES` / nullif(
					`performance_schema`.`events_statements_summary_by_digest`.`COUNT_STAR`,
					0
				)
			),
	...
	round(
		ifnull(
			(
				`performance_schema`.`events_statements_summary_by_digest`.`SUM_SORT_ROWS` / nullif(
					`performance_schema`.`events_statements_summary_by_digest`.`COUNT_STAR`,
					0
				)
			),
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$statements_with_temp_tables`;

CREATE VIEW `x$statements_with_temp_tables` AS SELECT
	`performance_schema`.`events_statements_summary_by_digest`.`DIGEST_TEXT` AS `query`,
	`performance_schema`.`events_statements_summary_by_digest`.`SCHEMA_NAME` AS `db`,
	`performance_schema`.`events_statements_summary_by_digest`.`COUNT_STAR` AS `exec_count`,
	`performance_schema`.`events_statements_summary_by_digest`.`SUM_TIMER_WAIT` AS `total_latency`,
	...
	round(
		ifnull(
			(
				`performance_schema`.`events_statements_summary_by_digest`.`SUM_CREATED_TMP_TABLES` / nullif(
					`performance_schema`.`events_statements_summary_by_digest`.`COUNT_STAR`,
					0
				)
			),
	...
	round(
		(
			ifnull(
				(
					`performance_schema`.`events_statements_summary_by_digest`.`SUM_CREATED_TMP_DISK_TABLES` / nullif(
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$statement_analysis`;

CREATE VIEW `x$statement_analysis` AS SELECT
	`performance_schema`.`events_statements_summary_by_digest`.`DIGEST_TEXT` AS `query`,
	`performance_schema`.`events_statements_summary_by_digest`.`SCHEMA_NAME` AS `db`,
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$user_summary`;

CREATE VIEW `x$user_summary` AS SELECT
...
IF (
 ...
 count(
	DISTINCT `performance_schema`.`accounts`.`HOST`
) AS `unique_hosts`,
 sum(`mem`.`current_allocated`) AS `current_memory`,
 sum(`mem`.`total_allocated`) AS `total_memory_allocated`
FROM
	(
		(
			(
				`performance_schema`.`accounts`
				LEFT JOIN `sys`.`x$user_summary_by_statement_latency` `stmt` ON (
					(
			...
			LEFT JOIN `sys`.`x$user_summary_by_file_io` `io` ON (
				(
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$user_summary_by_file_io`;

CREATE VIEW `x$user_summary_by_file_io` AS SELECT
...
IF (
 ...
 sum(
	`performance_schema`.`events_waits_summary_by_user_by_event_name`.`COUNT_STAR`
) AS `ios`,
 sum(
	`performance_schema`.`events_waits_summary_by_user_by_event_name`.`SUM_TIMER_WAIT`
) AS `io_latency`
FROM
	`performance_schema`.`events_waits_summary_by_user_by_event_name`
WHERE
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$user_summary_by_file_io_type`;

CREATE VIEW `x$user_summary_by_file_io_type` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$user_summary_by_stages`;

CREATE VIEW `x$user_summary_by_stages` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$user_summary_by_statement_latency`;

CREATE VIEW `x$user_summary_by_statement_latency` AS SELECT
...
IF (
 ...
 sum(
	`performance_schema`.`events_statements_summary_by_user_by_event_name`.`COUNT_STAR`
) AS `total`,
 sum(
	`performance_schema`.`events_statements_summary_by_user_by_event_name`.`SUM_TIMER_WAIT`
) AS `total_latency`,
 sum(
	`performance_schema`.`events_statements_summary_by_user_by_event_name`.`MAX_TIMER_WAIT`
) AS `max_latency`,
 sum(
	`performance_schema`.`events_statements_summary_by_user_by_event_name`.`SUM_LOCK_TIME`
) AS `lock_latency`,
 sum(
	`performance_schema`.`events_statements_summary_by_user_by_event_name`.`SUM_ROWS_SENT`
) AS `rows_sent`,
 sum(
	`performance_schema`.`events_statements_summary_by_user_by_event_name`.`SUM_ROWS_EXAMINED`
) AS `rows_examined`,
 sum(
	`performance_schema`.`events_statements_summary_by_user_by_event_name`.`SUM_ROWS_AFFECTED`
) AS `rows_affected`,
 (
	sum(
		`performance_schema`.`events_statements_summary_by_user_by_event_name`.`SUM_NO_INDEX_USED`
	) + sum(
		`performance_schema`.`events_statements_summary_by_user_by_event_name`.`SUM_NO_GOOD_INDEX_USED`
	)
) AS `full_scans`
FROM
	`performance_schema`.`events_statements_summary_by_user_by_event_name`
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$user_summary_by_statement_type`;

CREATE VIEW `x$user_summary_by_statement_type` AS SELECT
...
IF (
 ...
 (
	`performance_schema`.`events_statements_summary_by_user_by_event_name`.`SUM_NO_INDEX_USED` + `performance_schema`.`events_statements_summary_by_user_by_event_name`.`SUM_NO_GOOD_INDEX_USED`
) AS `full_scans`
FROM
	`performance_schema`.`events_statements_summary_by_user_by_event_name`
WHERE
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$waits_by_host_by_latency`;

CREATE VIEW `x$waits_by_host_by_latency` AS SELECT
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$waits_by_user_by_latency`;

CREATE VIEW `x$waits_by_user_by_latency` AS SELECT
...
WHERE
	(
		...
		AND (
			`performance_schema`.`events_waits_summary_by_user_by_event_name`.`USER` IS NOT NULL
		)
		AND (
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$waits_global_by_latency`;

CREATE VIEW `x$waits_global_by_latency` AS SELECT
...
ORDER BY
	`performance_schema`.`events_waits_summary_global_by_event_name`.`SUM_TIMER_WAIT` DESC;

-- ----------------------------
-- View structure for x$wait_classes_global_by_avg_latency
-- ----------------------------
DROP VIEW
IF EXISTS `x$wait_classes_global_by_avg_latency`;

CREATE VIEW `x$wait_classes_global_by_avg_latency` AS SELECT
	substring_index(
	...
	sum(
		`performance_schema`.`events_waits_summary_global_by_event_name`.`SUM_TIMER_WAIT`
	) AS `total_latency`,
	min(
		`performance_schema`.`events_waits_summary_global_by_event_name`.`MIN_TIMER_WAIT`
	) AS `min_latency`,
	ifnull(
		(
			sum(
	...
	max(
		`performance_schema`.`events_waits_summary_global_by_event_name`.`MAX_TIMER_WAIT`
	) AS `max_latency`
FROM
	`performance_schema`.`events_waits_summary_global_by_event_name`
WHERE
...
-- ----------------------------
DROP VIEW
IF EXISTS `x$wait_classes_global_by_latency`;

CREATE VIEW `x$wait_classes_global_by_latency` AS SELECT
	substring_index(
		`performance_schema`.`events_waits_summary_global_by_event_name`.`EVENT_NAME`,
		'/',
		3
...
DECLARE c_table_names CURSOR FOR SELECT
	TABLE_NAME
FROM
	INFORMATION_SCHEMA. TABLES
WHERE
	TABLE_SCHEMA = in_db_name ;
DECLARE CONTINUE HANDLER FOR NOT FOUND
SET v_done = TRUE ; SELECT
...
END
IF ;
SET @create_db_stmt := CONCAT(
	'CREATE DATABASE ',
	sys.quote_identifier (in_synonym)
) ; PREPARE create_db_stmt
FROM
	@create_db_stmt ; EXECUTE create_db_stmt ; DEALLOCATE PREPARE create_db_stmt ;
SET v_done = FALSE ; OPEN c_table_names ; c_table_names :
LOOP
...
SET @create_view_stmt = CONCAT(
	...
	'.',
	sys.quote_identifier (v_table)
) ; PREPARE create_view_stmt
FROM
	@create_view_stmt ; EXECUTE create_view_stmt ; DEALLOCATE PREPARE create_view_stmt ;
SET v_views_created = v_views_created + 1 ;
END
LOOP
	; CLOSE c_table_names ; SELECT
		CONCAT(
			'Created ',
			v_views_created,
			' view',
...
DECLARE c_sysviews_w_delta CURSOR FOR SELECT
	table_name
FROM
	tmp_sys_views_delta
ORDER BY
...
DECLARE CONTINUE HANDLER FOR NOT FOUND
SET v_done = TRUE ; SELECT
	INSTRUMENTED INTO v_this_thread_enabled
FROM
	PERFORMANCE_SCHEMA .threads
WHERE
	PROCESSLIST_ID = CONNECTION_ID() ;
IF (
	v_this_thread_enabled = 'YES'
) THEN
...
IF ;
IF (
	@sys.diagnostics.allow_i_s_tables IS NULL
) THEN

SET @sys.diagnostics.allow_i_s_tables = sys.sys_get_config (
...
IF ;
IF (
	@sys.diagnostics.include_raw IS NULL
) THEN

SET @sys.diagnostics.include_raw = sys.sys_get_config (
...
IF ;
IF (
	@sys.statement_truncate_len IS NULL
) THEN

SET @sys.statement_truncate_len = sys.sys_get_config (
...
END
IF ;
SET v_no_delta_names = CONCAT(
	's%{COUNT}.Variable_name NOT IN (',
...
IF (@sys.debug = 'ON') THEN
	SELECT
		CONCAT(
			'Updating Performance Schema configuration to ',
			in_auto_config
		) AS 'Debug' ;
	END
	IF ; CALL sys.ps_setup_save (0) ;
	IF (in_auto_config = 'medium') THEN
		UPDATE PERFORMANCE_SCHEMA .setup_consumers
	SET ENABLED = 'YES'
	WHERE
		NAME NOT LIKE '%\_history%' ; UPDATE PERFORMANCE_SCHEMA .setup_instruments
	SET ENABLED = 'YES',
	TIMED = 'YES'
WHERE
	NAME NOT LIKE 'wait/synch/%' ;
ELSEIF (in_auto_config = 'full') THEN
	UPDATE PERFORMANCE_SCHEMA .setup_consumers
SET ENABLED = 'YES' ; UPDATE PERFORMANCE_SCHEMA .setup_instruments
SET ENABLED = 'YES',
 TIMED = 'YES' ;
END
IF ; UPDATE PERFORMANCE_SCHEMA .threads
												...
												UNION ALL
															...
															UNION ALL
																...
																IF (
																	...
																	AND EXISTS (
																		...
																		AND TABLE_NAME = 'replication_applier_status'
																	),
																	'YES',
																	'NO'
																),
													...
													IF (@sys.debug = 'ON') THEN
														SELECT
															...
															v_has_replication AS 'Has_Replication' ;
														END
														IF ;
														IF (
															v_has_innodb IN ('DEFAULT', 'YES')
														) THEN

														SET @sys.diagnostics. SQL = 'SHOW ENGINE InnoDB STATUS' ; PREPARE stmt_innodb_status
														FROM
															@sys.diagnostics. SQL ;
														END
														IF ;
														...
														IF EXISTS tmp_sys_views_delta ; CREATE TEMPORARY TABLE tmp_sys_views_delta (
														...
														IF (@sys.debug = 'ON') THEN
															SELECT
																'Populating tmp_sys_views_delta' AS 'Debug' ;
															END
															IF ; INSERT INTO tmp_sys_views_delta
															VALUES
																(
																	'host_summary',
																	'%{TABLE}.statement_latency DESC',
																	'(e.statement_latency-IFNULL(s.statement_latency, 0)) DESC',
																	'(e.statements - IFNULL(s.statements, 0)) > 0',
																	NULL,
																	'host'
																),
																(
																	'host_summary_by_file_io',
																	'%{TABLE}.io_latency DESC',
																	'(e.io_latency-IFNULL(s.io_latency, 0)) DESC',
																	'(e.ios - IFNULL(s.ios, 0)) > 0',
																	NULL,
																	'host'
																),
																(
																	'host_summary_by_file_io_type',
																	'%{TABLE}.host, %{TABLE}.total_latency DESC',
																	'e.host, (e.total_latency-IFNULL(s.total_latency, 0)) DESC',
																	'(e.total - IFNULL(s.total, 0)) > 0',
																	NULL,
																	'host,event_name'
																),
																(
																...
																(
																	...
																	'(%{TABLE}.select_latency+%{TABLE}.insert_latency+%{TABLE}.update_latency+%{TABLE}.delete_latency) DESC',
																...
																(
																	...
																	'%{TABLE}.total_latency DESC',
																	'(e.total_latency-IFNULL(s.total_latency, 0)) DESC',
																	'(e.total_latency-IFNULL(s.total_latency, 0)) > 0',
																	100,
																	'table_schema,table_name'
																),
																(
																	'schema_tables_with_full_table_scans',
																	'%{TABLE}.rows_full_scanned DESC',
																	'(e.rows_full_scanned-IFNULL(s.rows_full_scanned, 0)) DESC',
																	'(e.rows_full_scanned-IFNULL(s.rows_full_scanned, 0)) > 0',
																	100,
																...
																(
																	...
																	'%{TABLE}.user, %{TABLE}.total_latency DESC',
																...
																(
																	...
																	'IFNULL(%{TABLE}.total_latency / NULLIF(%{TABLE}.total, 0), 0) DESC',
															...
															IF ; SELECT
																'  =======================  Configuration  =======================  ' AS '' ; SELECT
																	'GLOBAL VARIABLES' AS 'The following output is:' ;
																IF (v_has_ps_vars = 'YES') THEN
																	...
																	ELSE
																		...
																		IF (v_has_ps = 'YES') THEN
																			SELECT
																				'Performance Schema Setup - Actors' AS 'The following output is:' ; SELECT
																					*
																				FROM
																					PERFORMANCE_SCHEMA .setup_actors ; SELECT
																						'Performance Schema Setup - Consumers' AS 'The following output is:' ; SELECT
																							NAME AS Consumer,
																							ENABLED,
																							sys.ps_is_consumer_enabled (NAME) AS COLLECTS
																						FROM
																							PERFORMANCE_SCHEMA .setup_consumers ; SELECT
																								'Performance Schema Setup - Instruments' AS 'The following output is:' ; SELECT
																									SUBSTRING_INDEX(NAME, '/', 2) AS 'InstrumentClass',
																									ROUND(
																										100 * SUM(IF(ENABLED = 'YES', 1, 0)) / COUNT(*),
																										2
																									) AS 'EnabledPct',
																									ROUND(
																										100 * SUM(IF(TIMED = 'YES', 1, 0)) / COUNT(*),
																										2
																									) AS 'TimedPct'
																								FROM
																									PERFORMANCE_SCHEMA .setup_instruments
																								...
																								ORDER BY
																									SUBSTRING_INDEX(NAME, '/', 2) ; SELECT
																										'Performance Schema Setup - Objects' AS 'The following output is:' ; SELECT
																											*
																										FROM
																											PERFORMANCE_SCHEMA .setup_objects ; SELECT
																												'Performance Schema Setup - Threads' AS 'The following output is:' ; SELECT
																													`TYPE` AS ThreadType,
																													COUNT(*) AS 'Total',
																													ROUND(
																														100 * SUM(IF(INSTRUMENTED = 'YES', 1, 0)) / COUNT(*),
																														2
																													) AS 'InstrumentedPct'
																												FROM
																													PERFORMANCE_SCHEMA .threads
																												...
																												IF (v_has_replication = 'NO') THEN
																													SELECT
																														'No Replication Configured' AS 'Replication Status' ;
																													ELSE
																														SELECT
																															CONCAT(
																																...
																																v_has_ps_replication
																															) AS 'Replication Status' ;
																														IF (v_has_ps_replication = 'YES') THEN
																															SELECT
																																'Replication - Connection Configuration' AS 'The following output is:' ; SELECT
																																	*
																																FROM
																																...
																																IF (v_has_ps_replication = 'YES') THEN
																																	SELECT
																																		'Replication - Applier Configuration' AS 'The following output is:' ; SELECT
																																			*
																																		FROM
																																		...
																																		IF (
																																			...
																																			SELECT
																																				'Replication - Master Info Repository Configuration' AS 'The following output is:' ; SELECT
																																					Channel_name,
																																					HOST,
																																					User_name,
																																					PORT,
																																				...
																																				IF (
																																					...
																																					SELECT
																																						'Replication - Relay Log Repository Configuration' AS 'The following output is:' ; SELECT
																																							Channel_name,
																																							Sql_delay,
																																							Number_of_workers,
																																							Id
																																						...
																																						IF (
																																							...
																																							SELECT
																																								'Cluster Thread Blocks' AS 'The following output is:' ; SELECT
																																									*
																																								FROM
																																								...
																																								IF (
																																									...
																																									SELECT
																																										'  ========================  Initial Status  ========================  ' AS '' ;
																																									END
																																									IF ; DROP TEMPORARY TABLE
																																									IF EXISTS tmp_digests_start ; CALL sys.statement_performance_analyzer (
																																										'create_tmp',
																																										'tmp_digests_start',
																																										NULL
																																									) ; CALL sys.statement_performance_analyzer ('snapshot', NULL, NULL) ; CALL sys.statement_performance_analyzer (
																																										'save',
																																										'tmp_digests_start',
																																										NULL
																																									) ;
																																									...
																																									SET @sys.diagnostics. SQL = REPLACE (
																																										@sys.diagnostics.sql_gen_query_template,
																																										'%{OUTPUT}',
																																										'start'
																																									) ;
																																									IF (@sys.debug = 'ON') THEN
																																										SELECT
																																											'The following query will be used to generate the query for each sys view' AS 'Debug' ; SELECT
																																												@sys.diagnostics. SQL AS 'Debug' ;
																																											END
																																											IF ; PREPARE stmt_gen_query
																																											FROM
																																												@sys.diagnostics. SQL ;
																																											END
																																											IF ;
																																											...
																																											IF (@sys.debug = 'ON') THEN
																																												SELECT
																																													CONCAT(
																																														'The following queries are for storing the initial content of ',
																																														v_table_name
																																													) AS 'Debug' ;
																																												END
																																												IF ; CALL sys.execute_prepared_stmt (
																																													CONCAT(
																																												...
																																												SET @sys.diagnostics.table_name = CONCAT('x$', v_table_name) ; EXECUTE stmt_gen_query USING @sys.diagnostics.table_name ; SELECT
																																													CONCAT(
																																														@sys.diagnostics.sql_select,
																																												...
																																												FROM
																																													tmp_sys_views_delta
																																												WHERE
																																													TABLE_NAME = v_table_name ; SELECT
																																														CONCAT('Initial ', v_table_name) AS 'The following output is:' ; CALL sys.execute_prepared_stmt (
																																															@sys.diagnostics.sql_select
																																														) ;
																																													END
																																													IF ;
																																												...
																																												SET v_sleep = in_interval - (
																																													UNIX_TIMESTAMP(NOW(2)) - v_iter_start
																																												) ; SELECT
																																													NOW() AS 'Time',
																																													CONCAT(
																																														'Going to sleep for ',
																																														v_sleep,
																																														' seconds. Please do not interrupt'
																																													) AS 'The following output is:' ; DO
																																														SLEEP(in_interval) ;
																																													END
																																													IF ;
																																													SET v_iter_start = UNIX_TIMESTAMP(NOW(2)) ; SELECT
																																														NOW(),
																																														CONCAT(
																																															'Iteration Number ',
																																															IFNULL(v_output_count, 'NULL')
																																														) AS 'The following output is:' ;
																																													IF (@@log_bin = 1) THEN
																																														SELECT
																																															'SHOW MASTER STATUS' AS 'The following output is:' ; SHOW MASTER STATUS ;
																																														END
																																														IF ;
																																														IF (v_has_replication <> 'NO') THEN
																																															SELECT
																																																'SHOW SLAVE STATUS' AS 'The following output is:' ; SHOW SLAVE STATUS ;
																																															IF (v_has_ps_replication = 'YES') THEN
																																																SELECT
																																																	'Replication Connection Status' AS 'The following output is:' ; SELECT
																																																		*
																																																	FROM
																																																		PERFORMANCE_SCHEMA .replication_connection_status ; SELECT
																																																			'Replication Applier Status' AS 'The following output is:' ; SELECT
																																																				*
																																																			FROM
																																																				PERFORMANCE_SCHEMA .replication_applier_status
																																																			ORDER BY
																																																				CHANNEL_NAME ; SELECT
																																																					'Replication Applier Status - Coordinator' AS 'The following output is:' ; SELECT
																																																						*
																																																					FROM
																																																						PERFORMANCE_SCHEMA .replication_applier_status_by_coordinator
																																																					ORDER BY
																																																						CHANNEL_NAME ; SELECT
																																																							'Replication Applier Status - Worker' AS 'The following output is:' ; SELECT
																																																								*
																																																							FROM
																																																							...
																																																							IF (
																																																								...
																																																								SELECT
																																																									'Replication - Master Log Status' AS 'The following output is:' ; SELECT
																																																										Master_log_name,
																																																										Master_log_pos
																																																									FROM
																																																										mysql.slave_master_info ;
																																																									...
																																																									IF (
																																																										...
																																																										SELECT
																																																											'Replication - Relay Log Status' AS 'The following output is:' ; SELECT
																																																												sys.format_path (Relay_log_name) AS Relay_log_name,
																																																												Relay_log_pos,
																																																												Master_log_name,
																																																												Master_log_pos
																																																											FROM
																																																												mysql.slave_relay_log_info ; SELECT
																																																													'Replication - Worker Status' AS 'The following output is:' ; SELECT
																																																														Id,
																																																														sys.format_path (Relay_log_name) AS Relay_log_name,
																																																														Relay_log_pos,
																																																														Master_log_name,
																																																													...
																																																													SET v_table_name = CONCAT(
																																																														...
																																																														CONCAT(
																																																															...
																																																															v_table_name,
																																																															' ( Variable_name VARCHAR(193) NOT NULL, Variable_value VARCHAR(1024), Type VARCHAR(225) NOT NULL, Enabled ENUM(''YES'', ''NO'', ''PARTIAL'') NOT NULL, PRIMARY KEY (Type, Variable_name) ) ENGINE = InnoDB DEFAULT CHARSET=utf8'
																																																														)
																																																													) ;
																																																													...
																																																													END
																																																													IF ; CALL sys.execute_prepared_stmt (@sys.diagnostics. SQL) ; CALL sys.execute_prepared_stmt (
																																																														CONCAT(
																																																															'(SELECT Variable_value INTO @sys.diagnostics.output_time FROM ',
																																																															v_table_name,
																																																															' WHERE Type = ''System Time'' AND Variable_name = ''UNIX_TIMESTAMP()'')'
																																																														)
																																																													) ;
																																																													SET v_output_time = @sys.diagnostics.output_time ;
																																																													SET v_sql_status_summary_select = CONCAT(
																																																														v_sql_status_summary_select,
																																																														', CONCAT( LEFT(s',
																																																														v_output_count,
																																																														'.Variable_value, ',
																																																														v_status_summary_width,
																																																														'), IF(',
																																																														REPLACE (
																																																															v_no_delta_names,
																																																															'%{COUNT}',
																																																														...
																																																														' AND s',
																																																														v_output_count,
																																																														'.Variable_value REGEXP ''^[0-9]+(\\\\.[0-9]+)?$'', CONCAT('' ('', ROUND(s',
																																																														v_output_count,
																																																														'.Variable_value/',
																																																														v_output_time,
																																																														', 2), ''/sec)''), '''') ) AS ''Output ',
																																																													...
																																																													v_sql_status_summary_from = CONCAT(
																																																														v_sql_status_summary_from,
																																																														' ',
																																																												...
																																																												SET v_sql_status_summary_delta = CONCAT(
																																																													v_sql_status_summary_delta,
																																																													', IF(',
																																																													REPLACE (
																																																														v_no_delta_names,
																																																													...
																																																													' AND s',
																																																													(v_output_count - 1),
																																																													'.Variable_value REGEXP ''^[0-9]+(\\\\.[0-9]+)?$'' AND s',
																																																													v_output_count,
																																																													'.Variable_value REGEXP ''^[0-9]+(\\\\.[0-9]+)?$'', CONCAT(IF(s',
																																																													(v_output_count - 1),
																																																													'.Variable_value REGEXP ''^[0-9]+\\\\.[0-9]+$'' OR s',
																																																													v_output_count,
																																																													'.Variable_value REGEXP ''^[0-9]+\\\\.[0-9]+$'', ROUND((s',
																																																													v_output_count,
																																																													'.Variable_value-s',
																																																													(v_output_count - 1),
																																																													'.Variable_value), 2), (s',
																																																												...
																																																												IF (v_has_metrics) THEN
																																																													SELECT
																																																														'SELECT * FROM sys.metrics' AS 'The following output is:' ;
																																																													ELSE
																																																														SELECT
																																																															'sys.metrics equivalent' AS 'The following output is:' ;
																																																														END
																																																														IF ; CALL sys.execute_prepared_stmt (
																																																															CONCAT(
																																																																'SELECT Type, Variable_name, Enabled, Variable_value FROM ',
																																																																v_table_name,
																																																														...
																																																														IF (
																																																															...
																																																															SELECT
																																																																'SHOW ENGINE INNODB STATUS' AS 'The following output is:' ; EXECUTE stmt_innodb_status ; SELECT
																																																																	'InnoDB - Transactions' AS 'The following output is:' ; SELECT
																																																																		*
																																																																	FROM
																																																																	...
																																																																	IF (
																																																																		...
																																																																		SELECT
																																																																			'SHOW ENGINE NDBCLUSTER STATUS' AS 'The following output is:' ; EXECUTE stmt_ndbcluster_status ; SELECT
																																																																				'ndbinfo.memoryusage' AS 'The following output is:' ; SELECT
																																																																					node_id,
																																																																					memory_type,
																																																																				...
																																																																				FROM
																																																																					ndbinfo.memoryusage ;
																																																																				SET v_done = FALSE ; OPEN c_ndbinfo ; c_ndbinfo_loop :
																																																																				LOOP
																																																																				...
																																																																				IF ; SELECT
																																																																					CONCAT(
																																																																						'SELECT * FROM ndbinfo.',
																																																																						v_table_name
																																																																					) AS 'The following output is:' ; CALL sys.execute_prepared_stmt (
																																																																						CONCAT(
																																																																							'SELECT * FROM `ndbinfo`.`',
																																																																							v_table_name,
																																																																							'`'
																																																																				...
																																																																				END
																																																																				LOOP
																																																																					; CLOSE c_ndbinfo ; SELECT
																																																																						*
																																																																					FROM
																																																																						information_schema.FILES ;
																																																																					END
																																																																					IF ; SELECT
																																																																						'SELECT * FROM sys.processlist' AS 'The following output is:' ; SELECT
																																																																							PROCESSLIST .*
																																																																						FROM
																																																																							sys. PROCESSLIST ;
																																																																						IF (v_has_ps = 'YES') THEN
																																																																						...
																																																																						IF (
																																																																							...
																																																																							SELECT
																																																																								'SELECT * FROM sys.latest_file_io' AS 'The following output is:' ; SELECT
																																																																									*
																																																																								FROM
																																																																									sys.latest_file_io ;
																																																																								END
																																																																								...
																																																																								IF (
																																																																									...
																																																																									SELECT
																																																																										'SELECT * FROM sys.memory_by_host_by_current_bytes' AS 'The following output is:' ; SELECT
																																																																											*
																																																																										FROM
																																																																											sys.memory_by_host_by_current_bytes ; SELECT
																																																																												'SELECT * FROM sys.memory_by_thread_by_current_bytes' AS 'The following output is:' ; SELECT
																																																																													*
																																																																												FROM
																																																																													sys.memory_by_thread_by_current_bytes ; SELECT
																																																																														'SELECT * FROM sys.memory_by_user_by_current_bytes' AS 'The following output is:' ; SELECT
																																																																															*
																																																																														FROM
																																																																															sys.memory_by_user_by_current_bytes ; SELECT
																																																																																'SELECT * FROM sys.memory_global_by_current_bytes' AS 'The following output is:' ; SELECT
																																																																																	*
																																																																																FROM
																																																																																...
																																																																																IF ;
																																																																																SET v_runtime = (
																																																																																	UNIX_TIMESTAMP(NOW(2)) - v_start
																																																																																) ; UNTIL (
																																																																																	v_runtime + in_interval >= in_max_runtime
																																																																																)
																																																																																END
																																																																																REPEAT
																																																																																	;
																																																																																IF (v_has_ps = 'YES') THEN
																																																																																	SELECT
																																																																																		'SHOW ENGINE PERFORMANCE_SCHEMA STATUS' AS 'The following output is:' ; EXECUTE stmt_ps_status ;
																																																																																	END
																																																																																	IF ;
																																																																																	IF (
																																																																																		v_has_innodb IN ('DEFAULT', 'YES')
																																																																																	...
																																																																																	IF ; SELECT
																																																																																		...
																																																																																		IF (
																																																																																			...
																																																																																			SELECT
																																																																																				'Storage Engine Usage' AS 'The following output is:' ; SELECT
																																																																																					ENGINE,
																																																																																					COUNT(*) AS NUM_TABLES,
																																																																																				...
																																																																																				GROUP BY
																																																																																					ENGINE ; SELECT
																																																																																						'Schema Object Overview' AS 'The following output is:' ; SELECT
																																																																																							*
																																																																																						FROM
																																																																																							sys.schema_object_overview ; SELECT
																																																																																								'Tables without a PRIMARY KEY' AS 'The following output is:' ; SELECT
																																																																																									TABLES .TABLE_SCHEMA,
																																																																																									ENGINE,
																																																																																									COUNT(*) AS NumTables
																																																																																								FROM
																																																																																								...
																																																																																								IF (v_has_ps = 'YES') THEN
																																																																																									SELECT
																																																																																										'Unused Indexes' AS 'The following output is:' ; SELECT
																																																																																											object_schema,
																																																																																										...
																																																																																										IF (v_has_ps = 'YES') THEN
																																																																																											SELECT
																																																																																												'  =========================  Overall Status  =========================  ' AS '' ; SELECT
																																																																																													'CALL sys.ps_statement_avg_latency_histogram()' AS 'The following output is:' ; CALL sys.ps_statement_avg_latency_histogram () ; CALL sys.statement_performance_analyzer ('snapshot', NULL, NULL) ; CALL sys.statement_performance_analyzer (
																																																																																														'overall',
																																																																																														NULL,
																																																																																												...
																																																																																												IF (@sys.debug = 'ON') THEN
																																																																																													SELECT
																																																																																														...
																																																																																														IF (@sys.debug = 'ON') THEN
																																																																																															SELECT
																																																																																																CONCAT(
																																																																																																	'The following queries are for storing the final content of ',
																																																																																																	v_table_name
																																																																																																) AS 'Debug' ;
																																																																																															END
																																																																																															IF ; CALL sys.execute_prepared_stmt (
																																																																																															...
																																																																																															WHERE
																																																																																																TABLE_NAME = v_table_name ; SELECT
																																																																																																	CONCAT('Overall ', v_table_name) AS 'The following output is:' ; CALL sys.execute_prepared_stmt (
																																																																																																		@sys.diagnostics.sql_select
																																																																																																	) ;
																																																																																																END
																																																																																																IF ;
																																																																																																END
																																																																																																LOOP
																																																																																																	; CLOSE c_sysviews_w_delta ; DEALLOCATE PREPARE stmt_gen_query ; SELECT
																																																																																																		'  ======================  Delta Status  ======================  ' AS '' ; CALL sys.statement_performance_analyzer (
																																																																																																			'delta',
																																																																																																			'tmp_digests_start',
																																																																																																			'with_runtimes_in_95th_percentile'
																																																																																																		) ; CALL sys.statement_performance_analyzer ('cleanup', NULL, NULL) ; DROP TEMPORARY TABLE tmp_digests_start ;
																																																																																																	IF (@sys.debug = 'ON') THEN
																																																																																																		SELECT
																																																																																																			'The following query will be used to generate the query for each sys view delta' AS 'Debug' ; SELECT
																																																																																																				@sys.diagnostics.sql_gen_query_delta AS 'Debug' ;
																																																																																																			END
																																																																																																			IF ; PREPARE stmt_gen_query_delta
																																																																																																			FROM
																																																																																																				@sys.diagnostics.sql_gen_query_delta ;
																																																																																																			...
																																																																																																			END
																																																																																																			IF ;
																																																																																																			SET @sys.diagnostics.table_name = v_table_name ; EXECUTE stmt_gen_query_delta USING @sys.diagnostics.table_name ; SELECT
																																																																																																				CONCAT(
																																																																																																					@sys.diagnostics.sql_select,

																																																																																																				IF (
																																																																																																					where_delta IS NOT NULL,
																																																																																																					CONCAT('\n WHERE ', where_delta),
																																																																																																					''
																																																																																																				),

																																																																																																			IF (
																																																																																																				order_by_delta IS NOT NULL,
																																																																																																				CONCAT(
																																																																																																					'\n ORDER BY ',
																																																																																																					order_by_delta
																																																																																																				),
																																																																																																		...
																																																																																																		IF (
																																																																																																			...
																																																																																																			WHERE
																																																																																																				TABLE_NAME = v_table_name ; SELECT
																																																																																																					CONCAT('Delta ', v_table_name) AS 'The following output is:' ; CALL sys.execute_prepared_stmt (
																																																																																																						@sys.diagnostics.sql_select
																																																																																																					) ; CALL sys.execute_prepared_stmt (
																																																																																																						CONCAT(
																																																																																																				...
																																																																																																				LOOP
																																																																																																					; CLOSE c_sysviews_w_delta ;
																																																																																																				SET @@SESSION .group_concat_max_len = v_old_group_concat_max_len ; DEALLOCATE PREPARE stmt_gen_query_delta ; DROP TEMPORARY TABLE tmp_sys_views_delta ;
																																																																																																				END
																																																																																																				IF ;
																																																																																																				IF (v_has_metrics) THEN
																																																																																																					SELECT
																																																																																																					...
																																																																																																					ELSE
																																																																																																						...
																																																																																																						SET v_table_name = CONCAT('tmp_metrics_', v_count) ; CALL sys.execute_prepared_stmt (
																																																																																																							CONCAT(
																																																																																																								'DROP TEMPORARY TABLE IF EXISTS ',
																																																																																																								v_table_name
																																																																																																							)
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `execute_prepared_stmt`;
DELIMITER ;;


CREATE  PROCEDURE `execute_prepared_stmt` (
	IN in_query LONGTEXT CHARACTER
	SET UTF8
...
IF (@sys.debug = 'ON') THEN
	SELECT
		@sys.execute_prepared_stmt. SQL AS 'Debug' ;
	END
	IF ; PREPARE sys_execute_prepared_stmt
	FROM
		@sys.execute_prepared_stmt. SQL ; EXECUTE sys_execute_prepared_stmt ; DEALLOCATE PREPARE sys_execute_prepared_stmt ;
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_setup_disable_background_threads`;
DELIMITER ;;


CREATE  PROCEDURE `ps_setup_disable_background_threads` () MODIFIES SQL DATA SQL SECURITY INVOKER COMMENT '\n Description\n \n Disable all background thread instrumentation within Performance Schema.\n \n Parameters\n \n None.\n \n Example\n \n mysql> CALL sys.ps_setup_disable_background_threads();\n +--------------------------------+\n | summary                        |\n +--------------------------------+\n | Disabled 18 background threads |\n +--------------------------------+\n 1 row in set (0.00 sec)\n '
BEGIN
	UPDATE PERFORMANCE_SCHEMA .threads
SET instrumented = 'NO'
WHERE
	type = 'BACKGROUND' ; SELECT
		CONCAT(
			'Disabled ',
			@rows := ROW_COUNT(),
			' background thread',
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_setup_disable_consumer`;
DELIMITER ;;


CREATE  PROCEDURE `ps_setup_disable_consumer` (IN consumer VARCHAR(128)) MODIFIES SQL DATA SQL SECURITY INVOKER COMMENT '\n Description\n \n Disables consumers within Performance Schema \n matching the input pattern.\n \n Parameters\n \n consumer (VARCHAR(128)):\n A LIKE pattern match (using "%consumer%") of consumers to disable\n \n Example\n \n To disable all consumers:\n \n mysql> CALL sys.ps_setup_disable_consumer('''');\n +--------------------------+\n | summary                  |\n +--------------------------+\n | Disabled 15 consumers    |\n +--------------------------+\n 1 row in set (0.02 sec)\n \n To disable just the event_stage consumers:\n \n mysql> CALL sys.ps_setup_disable_comsumers(''stage'');\n +------------------------+\n | summary                |\n +------------------------+\n | Disabled 3 consumers   |\n +------------------------+\n 1 row in set (0.00 sec)\n '
BEGIN
	UPDATE PERFORMANCE_SCHEMA .setup_consumers
SET enabled = 'NO'
WHERE
	NAME LIKE CONCAT('%', consumer, '%') ; SELECT
		CONCAT(
			'Disabled ',
			@rows := ROW_COUNT(),
			' consumer',
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_setup_disable_instrument`;
DELIMITER ;;


CREATE  PROCEDURE `ps_setup_disable_instrument` (IN in_pattern VARCHAR(128)) MODIFIES SQL DATA SQL SECURITY INVOKER COMMENT '\n Description\n \n Disables instruments within Performance Schema \n matching the input pattern.\n \n Parameters\n \n in_pattern (VARCHAR(128)):\n A LIKE pattern match (using "%in_pattern%") of events to disable\n \n Example\n \n To disable all mutex instruments:\n \n mysql> CALL sys.ps_setup_disable_instrument(''wait/synch/mutex'');\n +--------------------------+\n | summary                  |\n +--------------------------+\n | Disabled 155 instruments |\n +--------------------------+\n 1 row in set (0.02 sec)\n \n To disable just a specific TCP/IP based network IO instrument:\n \n mysql> CALL sys.ps_setup_disable_instrument(''wait/io/socket/sql/server_tcpip_socket'');\n +------------------------+\n | summary                |\n +------------------------+\n | Disabled 1 instruments |\n +------------------------+\n 1 row in set (0.00 sec)\n \n To disable all instruments:\n \n mysql> CALL sys.ps_setup_disable_instrument('''');\n +--------------------------+\n | summary                  |\n +--------------------------+\n | Disabled 547 instruments |\n +--------------------------+\n 1 row in set (0.01 sec)\n '
BEGIN
	UPDATE PERFORMANCE_SCHEMA .setup_instruments
SET enabled = 'NO',
 timed = 'NO'
WHERE
	NAME LIKE CONCAT('%', in_pattern, '%') ; SELECT
		CONCAT(
			'Disabled ',
			@rows := ROW_COUNT(),
			' instrument',
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_setup_disable_thread`;
DELIMITER ;;


CREATE  PROCEDURE `ps_setup_disable_thread` (IN in_connection_id BIGINT) MODIFIES SQL DATA SQL SECURITY INVOKER COMMENT '\n Description\n \n Disable the given connection/thread in Performance Schema.\n \n Parameters\n \n in_connection_id (BIGINT):\n The connection ID (PROCESSLIST_ID from performance_schema.threads\n or the ID shown within SHOW PROCESSLIST)\n \n Example\n \n mysql> CALL sys.ps_setup_disable_thread(3);\n +-------------------+\n | summary           |\n +-------------------+\n | Disabled 1 thread |\n +-------------------+\n 1 row in set (0.01 sec)\n \n To disable the current connection:\n \n mysql> CALL sys.ps_setup_disable_thread(CONNECTION_ID());\n +-------------------+\n | summary           |\n +-------------------+\n | Disabled 1 thread |\n +-------------------+\n 1 row in set (0.00 sec)\n '
BEGIN
	UPDATE PERFORMANCE_SCHEMA .threads
SET instrumented = 'NO'
WHERE
	processlist_id = in_connection_id ; SELECT
		CONCAT(
			'Disabled ',
			@rows := ROW_COUNT(),
			' thread',
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_setup_enable_background_threads`;
DELIMITER ;;


CREATE  PROCEDURE `ps_setup_enable_background_threads` () MODIFIES SQL DATA SQL SECURITY INVOKER COMMENT '\n Description\n \n Enable all background thread instrumentation within Performance Schema.\n \n Parameters\n \n None.\n \n Example\n \n mysql> CALL sys.ps_setup_enable_background_threads();\n +-------------------------------+\n | summary                       |\n +-------------------------------+\n | Enabled 18 background threads |\n +-------------------------------+\n 1 row in set (0.00 sec)\n '
BEGIN
	UPDATE PERFORMANCE_SCHEMA .threads
SET instrumented = 'YES'
WHERE
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_setup_enable_consumer`;
DELIMITER ;;


CREATE  PROCEDURE `ps_setup_enable_consumer` (IN consumer VARCHAR(128)) MODIFIES SQL DATA SQL SECURITY INVOKER COMMENT '\n Description\n \n Enables consumers within Performance Schema \n matching the input pattern.\n \n Parameters\n \n consumer (VARCHAR(128)):\n A LIKE pattern match (using "%consumer%") of consumers to enable\n \n Example\n \n To enable all consumers:\n \n mysql> CALL sys.ps_setup_enable_consumer('''');\n +-------------------------+\n | summary                 |\n +-------------------------+\n | Enabled 10 consumers    |\n +-------------------------+\n 1 row in set (0.02 sec)\n \n Query OK, 0 rows affected (0.02 sec)\n \n To enable just "waits" consumers:\n \n mysql> CALL sys.ps_setup_enable_consumer(''waits'');\n +-----------------------+\n | summary               |\n +-----------------------+\n | Enabled 3 consumers   |\n +-----------------------+\n 1 row in set (0.00 sec)\n \n Query OK, 0 rows affected (0.00 sec)\n '
BEGIN
	UPDATE PERFORMANCE_SCHEMA .setup_consumers
SET enabled = 'YES'
WHERE
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_setup_enable_instrument`;
DELIMITER ;;


CREATE  PROCEDURE `ps_setup_enable_instrument` (IN in_pattern VARCHAR(128)) MODIFIES SQL DATA SQL SECURITY INVOKER COMMENT '\n Description\n \n Enables instruments within Performance Schema \n matching the input pattern.\n \n Parameters\n \n in_pattern (VARCHAR(128)):\n A LIKE pattern match (using "%in_pattern%") of events to enable\n \n Example\n \n To enable all mutex instruments:\n \n mysql> CALL sys.ps_setup_enable_instrument(''wait/synch/mutex'');\n +-------------------------+\n | summary                 |\n +-------------------------+\n | Enabled 155 instruments |\n +-------------------------+\n 1 row in set (0.02 sec)\n \n Query OK, 0 rows affected (0.02 sec)\n \n To enable just a specific TCP/IP based network IO instrument:\n \n mysql> CALL sys.ps_setup_enable_instrument(''wait/io/socket/sql/server_tcpip_socket'');\n +-----------------------+\n | summary               |\n +-----------------------+\n | Enabled 1 instruments |\n +-----------------------+\n 1 row in set (0.00 sec)\n \n Query OK, 0 rows affected (0.00 sec)\n \n To enable all instruments:\n \n mysql> CALL sys.ps_setup_enable_instrument('''');\n +-------------------------+\n | summary                 |\n +-------------------------+\n | Enabled 547 instruments |\n +-------------------------+\n 1 row in set (0.01 sec)\n \n Query OK, 0 rows affected (0.01 sec)\n '
BEGIN
	UPDATE PERFORMANCE_SCHEMA .setup_instruments
SET enabled = 'YES',
 timed = 'YES'
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_setup_enable_thread`;
DELIMITER ;;


CREATE  PROCEDURE `ps_setup_enable_thread` (IN in_connection_id BIGINT) MODIFIES SQL DATA SQL SECURITY INVOKER COMMENT '\n Description\n \n Enable the given connection/thread in Performance Schema.\n \n Parameters\n \n in_connection_id (BIGINT):\n The connection ID (PROCESSLIST_ID from performance_schema.threads\n or the ID shown within SHOW PROCESSLIST)\n \n Example\n \n mysql> CALL sys.ps_setup_enable_thread(3);\n +------------------+\n | summary          |\n +------------------+\n | Enabled 1 thread |\n +------------------+\n 1 row in set (0.01 sec)\n \n To enable the current connection:\n \n mysql> CALL sys.ps_setup_enable_thread(CONNECTION_ID());\n +------------------+\n | summary          |\n +------------------+\n | Enabled 1 thread |\n +------------------+\n 1 row in set (0.00 sec)\n '
BEGIN
	UPDATE PERFORMANCE_SCHEMA .threads
SET instrumented = 'YES'
WHERE
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_setup_reload_saved`;
DELIMITER ;;


CREATE  PROCEDURE `ps_setup_reload_saved` () MODIFIES SQL DATA SQL SECURITY INVOKER COMMENT '\n Description\n \n Reloads a saved Performance Schema configuration,\n so that you can alter the setup for debugging purposes, \n but restore it to a previous state.\n \n Use the companion procedure - ps_setup_save(), to \n save a configuration.\n \n Requires the SUPER privilege for "SET sql_log_bin = 0;".\n \n Parameters\n \n None.\n \n Example\n \n mysql> CALL sys.ps_setup_save();\n Query OK, 0 rows affected (0.08 sec)\n \n mysql> UPDATE performance_schema.setup_instruments SET enabled = ''YES'', timed = ''YES'';\n Query OK, 547 rows affected (0.40 sec)\n Rows matched: 784  Changed: 547  Warnings: 0\n \n /* Run some tests that need more detailed instrumentation here */\n \n mysql> CALL sys.ps_setup_reload_saved();\n Query OK, 0 rows affected (0.32 sec)\n '
BEGIN
...
IF (
	v_lock_used_by != CONNECTION_ID()
) THEN

SET v_signal_message = CONCAT(
	'The sys.ps_setup_save lock is currently owned by ',
	v_lock_used_by
) ; SIGNAL SQLSTATE
VALUE
	'90002'
...
IF ; DELETE
FROM
	PERFORMANCE_SCHEMA .setup_actors ; INSERT INTO PERFORMANCE_SCHEMA .setup_actors SELECT
		*
	FROM
		tmp_setup_actors ;
	BEGIN
	...
	DECLARE c_consumers CURSOR FOR SELECT
		NAME,
		ENABLED
	FROM
		tmp_setup_consumers ;
	DECLARE CONTINUE HANDLER FOR NOT FOUND
	SET v_done = TRUE ;
	SET v_done = FALSE ; OPEN c_consumers ; c_consumers_loop :
	LOOP
		FETCH c_consumers INTO v_name,
		v_enabled ;
	IF v_done THEN
		LEAVE c_consumers_loop ;
	END
	IF ; UPDATE PERFORMANCE_SCHEMA .setup_consumers
	...
	LOOP
		; CLOSE c_consumers ;
	END ; UPDATE PERFORMANCE_SCHEMA .setup_instruments
...
DECLARE c_threads CURSOR FOR SELECT
	THREAD_ID,
	INSTRUMENTED
FROM
	tmp_threads ;
DECLARE CONTINUE HANDLER FOR NOT FOUND
SET v_done = TRUE ;
SET v_done = FALSE ; OPEN c_threads ; c_threads_loop :
LOOP
	FETCH c_threads INTO v_thread_id,
	v_instrumented ;
IF v_done THEN
...
LOOP
	; CLOSE c_threads ;
END ; UPDATE PERFORMANCE_SCHEMA .threads
SET INSTRUMENTED =
IF (
...
WHERE
	THREAD_ID NOT IN (
		...
		FROM
			tmp_threads
	) ; DROP TEMPORARY TABLE tmp_setup_actors ; DROP TEMPORARY TABLE tmp_setup_consumers ; DROP TEMPORARY TABLE tmp_setup_instruments ; DROP TEMPORARY TABLE tmp_threads ; SELECT
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_setup_reset_to_default`;
DELIMITER ;;


CREATE  PROCEDURE `ps_setup_reset_to_default` (IN in_verbose BOOLEAN) MODIFIES SQL DATA SQL SECURITY INVOKER COMMENT '\n Description\n \n Resets the Performance Schema setup to the default settings.\n \n Parameters\n \n in_verbose (BOOLEAN):\n Whether to print each setup stage (including the SQL) whilst running.\n \n Example\n \n mysql> CALL sys.ps_setup_reset_to_default(true)\\G\n *************************** 1. row ***************************\n status: Resetting: setup_actors\n DELETE\n FROM performance_schema.setup_actors\n WHERE NOT (HOST = ''%'' AND USER = ''%'' AND ROLE = ''%'')\n 1 row in set (0.00 sec)\n \n *************************** 1. row ***************************\n status: Resetting: setup_actors\n INSERT IGNORE INTO performance_schema.setup_actors\n VALUES (''%'', ''%'', ''%'')\n 1 row in set (0.00 sec)\n ...\n \n mysql> CALL sys.ps_setup_reset_to_default(false)\\G\n Query OK, 0 rows affected (0.00 sec)\n '
BEGIN
...
IF (in_verbose) THEN
	...
	END
	IF ; PREPARE reset_stmt
	FROM
		@QUERY ; EXECUTE reset_stmt ; DEALLOCATE PREPARE reset_stmt ;
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_setup_save`;
DELIMITER ;;


CREATE  PROCEDURE `ps_setup_save` (IN in_timeout INT) MODIFIES SQL DATA SQL SECURITY INVOKER COMMENT '\n Description\n \n Saves the current configuration of Performance Schema, \n so that you can alter the setup for debugging purposes, \n but restore it to a previous state.\n \n Use the companion procedure - ps_setup_reload_saved(), to \n restore the saved config.\n \n The named lock "sys.ps_setup_save" is taken before the\n current configuration is saved. If the attempt to get the named\n lock times out, an error occurs.\n \n The lock is released after the settings have been restored by\n calling ps_setup_reload_saved().\n \n Requires the SUPER privilege for "SET sql_log_bin = 0;".\n \n Parameters\n \n in_timeout INT\n The timeout in seconds used when trying to obtain the lock.\n A negative timeout means infinite timeout.\n \n Example\n \n mysql> CALL sys.ps_setup_save(-1);\n Query OK, 0 rows affected (0.08 sec)\n \n mysql> UPDATE performance_schema.setup_instruments \n ->    SET enabled = ''YES'', timed = ''YES'';\n Query OK, 547 rows affected (0.40 sec)\n Rows matched: 784  Changed: 547  Warnings: 0\n \n /* Run some tests that need more detailed instrumentation here */\n \n mysql> CALL sys.ps_setup_reload_saved();\n Query OK, 0 rows affected (0.32 sec)\n '
BEGIN
...
IF v_lock_result THEN
	DROP TEMPORARY TABLE
IF EXISTS tmp_setup_actors ; DROP TEMPORARY TABLE
IF EXISTS tmp_setup_consumers ; DROP TEMPORARY TABLE
IF EXISTS tmp_setup_instruments ; DROP TEMPORARY TABLE
IF EXISTS tmp_threads ; CREATE TEMPORARY TABLE tmp_setup_actors LIKE PERFORMANCE_SCHEMA .setup_actors ; CREATE TEMPORARY TABLE tmp_setup_consumers LIKE PERFORMANCE_SCHEMA .setup_consumers ; CREATE TEMPORARY TABLE tmp_setup_instruments LIKE PERFORMANCE_SCHEMA .setup_instruments ; CREATE TEMPORARY TABLE tmp_threads (
	THREAD_ID BIGINT UNSIGNED NOT NULL PRIMARY KEY,
	INSTRUMENTED enum ('YES', 'NO') NOT NULL
) ; INSERT INTO tmp_setup_actors SELECT
	*
FROM
	PERFORMANCE_SCHEMA .setup_actors ; INSERT INTO tmp_setup_consumers SELECT
		*
	FROM
		PERFORMANCE_SCHEMA .setup_consumers ; INSERT INTO tmp_setup_instruments SELECT
			*
		FROM
			PERFORMANCE_SCHEMA .setup_instruments ; INSERT INTO tmp_threads SELECT
				THREAD_ID,
				INSTRUMENTED
			FROM
				PERFORMANCE_SCHEMA .threads ;
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_setup_show_disabled`;
DELIMITER ;;
...
BEGIN
	SELECT
		@@PERFORMANCE_SCHEMA AS performance_schema_enabled ; SELECT
			CONCAT(
				'\'',
				USER,
				'\'@\'',
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_setup_show_disabled_consumers`;
DELIMITER ;;


CREATE  PROCEDURE `ps_setup_show_disabled_consumers` () READS SQL DATA DETERMINISTIC SQL SECURITY INVOKER COMMENT '\n Description\n \n Shows all currently disabled consumers.\n \n Parameters\n \n None\n \n Example\n \n mysql> CALL sys.ps_setup_show_disabled_consumers();\n \n +---------------------------+\n | disabled_consumers        |\n +---------------------------+\n | events_statements_current |\n | global_instrumentation    |\n | thread_instrumentation    |\n | statements_digest         |\n +---------------------------+\n 4 rows in set (0.05 sec)\n '
BEGIN
	SELECT
		NAME AS disabled_consumers
	FROM
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_setup_show_disabled_instruments`;
DELIMITER ;;


CREATE  PROCEDURE `ps_setup_show_disabled_instruments` () READS SQL DATA DETERMINISTIC SQL SECURITY INVOKER COMMENT '\n Description\n \n Shows all currently disabled instruments.\n \n Parameters\n \n None\n \n Example\n \n mysql> CALL sys.ps_setup_show_disabled_instruments();\n '
BEGIN
	SELECT
		NAME AS disabled_instruments,
		timed
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_setup_show_enabled`;
DELIMITER ;;
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_setup_show_enabled_consumers`;
DELIMITER ;;


CREATE  PROCEDURE `ps_setup_show_enabled_consumers` () READS SQL DATA DETERMINISTIC SQL SECURITY INVOKER COMMENT '\n Description\n \n Shows all currently enabled consumers.\n \n Parameters\n \n None\n \n Example\n \n mysql> CALL sys.ps_setup_show_enabled_consumers();\n \n +---------------------------+\n | enabled_consumers         |\n +---------------------------+\n | events_statements_current |\n | global_instrumentation    |\n | thread_instrumentation    |\n | statements_digest         |\n +---------------------------+\n 4 rows in set (0.05 sec)\n '
BEGIN
	SELECT
		NAME AS enabled_consumers
	FROM
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_setup_show_enabled_instruments`;
DELIMITER ;;


CREATE  PROCEDURE `ps_setup_show_enabled_instruments` () READS SQL DATA DETERMINISTIC SQL SECURITY INVOKER COMMENT '\n Description\n \n Shows all currently enabled instruments.\n \n Parameters\n \n None\n \n Example\n \n mysql> CALL sys.ps_setup_show_enabled_instruments();\n '
BEGIN
	SELECT
		NAME AS enabled_instruments,
		timed
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_statement_avg_latency_histogram`;
DELIMITER ;;


CREATE  PROCEDURE `ps_statement_avg_latency_histogram` () READS SQL DATA SQL SECURITY INVOKER COMMENT '\n Description\n \n Outputs a textual histogram graph of the average latency values\n across all normalized queries tracked within the Performance Schema\n events_statements_summary_by_digest table.\n \n Can be used to show a very high level picture of what kind of \n latency distribution statements running within this instance have.\n \n Parameters\n \n None.\n \n Example\n \n mysql> CALL sys.ps_statement_avg_latency_histogram()\\G\n *************************** 1. row ***************************\n Performance Schema Statement Digest Average Latency Histogram:\n \n . = 1 unit\n * = 2 units\n # = 3 units\n \n (0 - 38ms)     240 | ################################################################################\n (38 - 77ms)    38  | ......................................\n (77 - 115ms)   3   | ...\n (115 - 154ms)  62  | *******************************\n (154 - 192ms)  3   | ...\n (192 - 231ms)  0   |\n (231 - 269ms)  0   |\n (269 - 307ms)  0   |\n (307 - 346ms)  0   |\n (346 - 384ms)  1   | .\n (384 - 423ms)  1   | .\n (423 - 461ms)  0   |\n (461 - 499ms)  0   |\n (499 - 538ms)  0   |\n (538 - 576ms)  0   |\n (576 - 615ms)  1   | .\n \n Total Statements: 350; Buckets: 16; Bucket Size: 38 ms;\n '
BEGIN
	SELECT
		CONCAT(
			'\n',
					...
					ROUND(
						(
							@bucket_size := (
								SELECT
									ROUND(
										(MAX(avg_us) - MIN(avg_us)) / (@buckets := 16)
									) AS size
								FROM
					...
					(
						@max_label_size := (
							(
								1 + LENGTH(
									ROUND(
										(@bucket_size * 15) / @unit_div
									)
								) + 3 + LENGTH(
									ROUND(@bucket_size * 16) / @unit_div
								)
							) + 1
						)
					) - LENGTH(@label_inner)
				),
				@count_in_bucket := IFNULL(
					(
						SELECT
							SUM(cnt)
						FROM
							sys.x$ps_digest_avg_latency_distribution AS b1
						WHERE
							b1.avg_us <= @bucket_size
					),
					0
				)
			),
		...
		REPEAT
			...
			IFNULL(
				...
				REPEAT
					(
						...
						IF (
							@count_in_bucket < (@one_unit := 40),
							'.',

						IF (
							@count_in_bucket < (@two_unit := 80),
							'*',
							'#'
						)
						),
					...
					IF (
						@count_in_bucket < @one_unit,
						@count_in_bucket,

					IF (
						@count_in_bucket < @two_unit,
						@count_in_bucket / 2,
						@count_in_bucket / 3
					)
					)
			...
			@label := CONCAT(
				@label_inner := CONCAT(
					'\n(',
					ROUND(@bucket_size / @unit_div),
					' - ',
					ROUND((@bucket_size * 2) / @unit_div),
					@unit,
					')'
				),
			...
			REPEAT
				(
					' ',
					@max_label_size - LENGTH(@label_inner)
				),
				@count_in_bucket := IFNULL(
					(
						SELECT
				...
				@count_in_bucket := IFNULL(
					(
						...
						FROM
							sys.x$ps_digest_avg_latency_distribution AS b1
						WHERE
							b1.avg_us > @bucket_size * 2
						AND b1.avg_us <= @bucket_size * 3
					),
					0
				)
			),
				...
				@count_in_bucket := IFNULL(
					(
						...
						FROM
							sys.x$ps_digest_avg_latency_distribution AS b1
						WHERE
							b1.avg_us > @bucket_size * 3
						AND b1.avg_us <= @bucket_size * 4
					),
					0
				)
			),
				...
				@count_in_bucket := IFNULL(
					(
						...
						FROM
							sys.x$ps_digest_avg_latency_distribution AS b1
						WHERE
							b1.avg_us > @bucket_size * 4
						AND b1.avg_us <= @bucket_size * 5
					),
					0
				)
			),
				...
				@count_in_bucket := IFNULL(
					(
						...
						FROM
							sys.x$ps_digest_avg_latency_distribution AS b1
						WHERE
							b1.avg_us > @bucket_size * 5
						AND b1.avg_us <= @bucket_size * 6
					),
					0
				)
			),
				...
				@count_in_bucket := IFNULL(
					(
						...
						FROM
							sys.x$ps_digest_avg_latency_distribution AS b1
						WHERE
							b1.avg_us > @bucket_size * 6
						AND b1.avg_us <= @bucket_size * 7
					),
					0
				)
			),
				...
				@count_in_bucket := IFNULL(
					(
						...
						FROM
							sys.x$ps_digest_avg_latency_distribution AS b1
						WHERE
							b1.avg_us > @bucket_size * 7
						AND b1.avg_us <= @bucket_size * 8
					),
					0
				)
			),
				...
				@count_in_bucket := IFNULL(
					(
						...
						FROM
							sys.x$ps_digest_avg_latency_distribution AS b1
						WHERE
							b1.avg_us > @bucket_size * 8
						AND b1.avg_us <= @bucket_size * 9
					),
					0
				)
			),
				...
				@count_in_bucket := IFNULL(
					(
						...
						FROM
							sys.x$ps_digest_avg_latency_distribution AS b1
						WHERE
							b1.avg_us > @bucket_size * 9
						AND b1.avg_us <= @bucket_size * 10
					),
					0
				)
			),
				...
				@count_in_bucket := IFNULL(
					(
						...
						FROM
							sys.x$ps_digest_avg_latency_distribution AS b1
						WHERE
							b1.avg_us > @bucket_size * 10
						AND b1.avg_us <= @bucket_size * 11
					),
					0
				)
			),
				...
				@count_in_bucket := IFNULL(
					(
						...
						FROM
							sys.x$ps_digest_avg_latency_distribution AS b1
						WHERE
							b1.avg_us > @bucket_size * 11
						AND b1.avg_us <= @bucket_size * 12
					),
					0
				)
			),
				...
				@count_in_bucket := IFNULL(
					(
						...
						FROM
							sys.x$ps_digest_avg_latency_distribution AS b1
						WHERE
							b1.avg_us > @bucket_size * 12
						AND b1.avg_us <= @bucket_size * 13
					),
					0
				)
			),
				...
				@count_in_bucket := IFNULL(
					(
						...
						FROM
							sys.x$ps_digest_avg_latency_distribution AS b1
						WHERE
							b1.avg_us > @bucket_size * 13
						AND b1.avg_us <= @bucket_size * 14
					),
					0
				)
			),
				...
				@count_in_bucket := IFNULL(
					(
						...
						FROM
							sys.x$ps_digest_avg_latency_distribution AS b1
						WHERE
							b1.avg_us > @bucket_size * 14
						AND b1.avg_us <= @bucket_size * 15
					),
					0
				)
			),
				...
				@count_in_bucket := IFNULL(
					(
						...
						FROM
							sys.x$ps_digest_avg_latency_distribution AS b1
						WHERE
							b1.avg_us > @bucket_size * 15
						AND b1.avg_us <= @bucket_size * 16
					),
					0
				)
			),
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_trace_statement_digest`;
DELIMITER ;;
...
FROM
	PERFORMANCE_SCHEMA .threads
WHERE
	PROCESSLIST_ID = CONNECTION_ID() ; CALL sys.ps_setup_disable_thread (CONNECTION_ID()) ; DROP TEMPORARY TABLE
IF EXISTS stmt_trace ; CREATE TEMPORARY TABLE stmt_trace (
...
IF EXISTS stmt_stages ; CREATE TEMPORARY TABLE stmt_stages (
	event_id BIGINT UNSIGNED,
...
IF v_start_fresh THEN
	TRUNCATE TABLE PERFORMANCE_SCHEMA .events_statements_history_long ; TRUNCATE TABLE PERFORMANCE_SCHEMA .events_stages_history_long ;
END
IF ;
SET v_auto_enable = in_auto_enable ;
IF v_auto_enable THEN
	CALL sys.ps_setup_save (0) ; UPDATE PERFORMANCE_SCHEMA .threads
SET INSTRUMENTED =
IF (
...
SET ENABLED = 'YES'
WHERE
	NAME NOT LIKE '%\_history'
AND NAME NOT LIKE 'events_wait%'
AND NAME NOT LIKE 'events_transactions%'
AND NAME <> 'statements_digest' ; UPDATE PERFORMANCE_SCHEMA .setup_instruments
SET ENABLED = 'YES',
 TIMED = 'YES'
WHERE
	NAME LIKE 'statement/%'
...
WHILE v_runtime < in_runtime DO
	SELECT
		UNIX_TIMESTAMP() INTO v_start ; INSERT IGNORE INTO stmt_trace SELECT
			thread_id,
			timer_start,
			event_id,
			sql_text,
		...
		WHERE
			digest = in_digest ; INSERT IGNORE INTO stmt_stages SELECT
				stages.event_id,
				stmt_trace.event_id,
				stages.event_name,
				stages.timer_wait
			FROM
				PERFORMANCE_SCHEMA .events_stages_history_long AS stages
			JOIN stmt_trace ON stages.nesting_event_id = stmt_trace.event_id ; SELECT
				SLEEP(in_interval) INTO @sleep ;
			SET v_runtime = v_runtime + (UNIX_TIMESTAMP() - v_start) ;
			END
			WHILE ; SELECT
				"SUMMARY STATISTICS" ; SELECT
					COUNT(*) executions,
				...
				FROM
					...
					GROUP BY
						event_name
					ORDER BY
						SUM(timer_wait) DESC ; SELECT
							"LONGEST RUNNING STATEMENT" ; SELECT
								thread_id,
							...
							IF (@sql_id IS NOT NULL) THEN
								...
								ORDER BY
									event_id ;
								END
								IF ; DROP TEMPORARY TABLE stmt_trace ; DROP TEMPORARY TABLE stmt_stages ;
								...
								1146
							SET v_explain = FALSE ; PREPARE explain_stmt
							FROM
								@stmt ;
							END ;
							IF (v_explain) THEN
								EXECUTE explain_stmt ; DEALLOCATE PREPARE explain_stmt ;
							END
							IF ;
							END
							IF ;
...
DECLARE c_stack CURSOR FOR SELECT
	CONCAT(

		IF (
			nesting_event_id IS NOT NULL,
			CONCAT(nesting_event_id, ' -> '),
			''
		),
		event_id,
		'; ',
	...
	IF (
		event_name NOT LIKE 'wait/io%',
		SUBSTRING_INDEX(event_name, '/', - 2),

	IF (
		event_name NOT LIKE 'wait/io/file%'
		OR event_name NOT LIKE 'wait/io/socket%',
...
IF (
 ...
 '", ',
 CASE
WHEN event_name LIKE 'wait/io/file%' THEN
...
WHEN event_name LIKE 'statement/%' THEN
	CONCAT(
		...
		CASE
	WHEN event_name LIKE 'statement/com/%' THEN
		' style=filled, color=darkseagreen'
	ELSE

	IF (
		(timer_wait / 1000000000000) > @@long_query_time,
		...
		UNION
			(
				SELECT
					...
					IF (
						event_name NOT LIKE 'wait/synch/mutex%',
						IFNULL(CONCAT(' - ', operation), ''),
						''
					),
...
FROM
	PERFORMANCE_SCHEMA .threads
WHERE
	PROCESSLIST_ID = CONNECTION_ID() ; CALL sys.ps_setup_disable_thread (CONNECTION_ID()) ;
IF (in_auto_setup) THEN
	CALL sys.ps_setup_save (0) ; DELETE
FROM
	PERFORMANCE_SCHEMA .setup_actors ; UPDATE PERFORMANCE_SCHEMA .threads
SET INSTRUMENTED =
IF (
	THREAD_ID = in_thread_id,
	'YES',
...
IF (in_start_fresh) THEN
	TRUNCATE PERFORMANCE_SCHEMA .events_transactions_history_long ; TRUNCATE PERFORMANCE_SCHEMA .events_statements_history_long ; TRUNCATE PERFORMANCE_SCHEMA .events_stages_history_long ; TRUNCATE PERFORMANCE_SCHEMA .events_waits_history_long ;
END
IF ; DROP TEMPORARY TABLE
IF EXISTS tmp_events ; CREATE TEMPORARY TABLE tmp_events (
...
VALUES
	(
		...
		CONCAT(
			'Data collection starting for THREAD_ID = ',
			in_thread_id
		) AS 'Info' ;
...
SET v_done = FALSE ; OPEN c_stack ; c_stack_loop :
LOOP
	FETCH c_stack INTO v_event,
	v_min_event_id ;
IF v_done THEN
	LEAVE c_stack_loop ;
END
...
IF (LENGTH(v_event) > 0) THEN
	INSERT INTO tmp_events
VALUES
	(v_min_event_id, v_event) ;
END
IF ;
END
LOOP
	; CLOSE c_stack ; SELECT
		SLEEP(in_interval) INTO @sleep ;
	SET v_runtime = (UNIX_TIMESTAMP() - v_start) ;
	END
	WHILE ; INSERT INTO tmp_events
	VALUES
		(v_min_event_id + 1, '}') ;
	SET @QUERY = CONCAT(
		'SELECT event FROM tmp_events ORDER BY event_id INTO OUTFILE ''',
		in_outfile,
		''' FIELDS ESCAPED BY '''' LINES TERMINATED BY '''''
	) ; PREPARE stmt_output
	FROM
		@QUERY ; EXECUTE stmt_output ; DEALLOCATE PREPARE stmt_output ; SELECT
			CONCAT(
				'Stack trace written to ',
				in_outfile
			) AS 'Info' ; SELECT
				CONCAT(
					'dot -Tpdf -o /tmp/stack_',
					in_thread_id,
					'.pdf ',
					in_outfile
				) AS 'Convert to PDF' ; SELECT
					CONCAT(
						'dot -Tpng -o /tmp/stack_',
						in_thread_id,
						'.png ',
						in_outfile
					) AS 'Convert to PNG' ; DROP TEMPORARY TABLE tmp_events ;
				IF (in_auto_setup) THEN
					CALL sys.ps_setup_reload_saved () ;
				END
				IF ;
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `ps_truncate_all_tables`;
DELIMITER ;;


CREATE  PROCEDURE `ps_truncate_all_tables` (IN in_verbose BOOLEAN) MODIFIES SQL DATA DETERMINISTIC SQL SECURITY INVOKER COMMENT '\n Description\n \n Truncates all summary tables within Performance Schema, \n resetting all aggregated instrumentation as a snapshot.\n \n Parameters\n \n in_verbose (BOOLEAN):\n Whether to print each TRUNCATE statement before running\n \n Example\n \n mysql> CALL sys.ps_truncate_all_tables(false);\n +---------------------+\n | summary             |\n +---------------------+\n | Truncated 44 tables |\n +---------------------+\n 1 row in set (0.10 sec)\n \n Query OK, 0 rows affected (0.10 sec)\n '
BEGIN

DECLARE v_done INT DEFAULT FALSE ;
DECLARE v_total_tables INT DEFAULT 0 ;
DECLARE v_ps_table VARCHAR (64) ;
DECLARE ps_tables CURSOR FOR SELECT
	table_name
FROM
	INFORMATION_SCHEMA. TABLES
WHERE
...
DECLARE CONTINUE HANDLER FOR NOT FOUND
SET v_done = TRUE ; OPEN ps_tables ; ps_tables_loop :
LOOP
...
IF in_verbose THEN
	...
	END
	IF ; PREPARE truncate_stmt
	FROM
		@truncate_stmt ; EXECUTE truncate_stmt ; DEALLOCATE PREPARE truncate_stmt ;
	SET v_total_tables = v_total_tables + 1 ;
	END
	LOOP
		; CLOSE ps_tables ; SELECT
			CONCAT(
				'Truncated ',
				v_total_tables,
				' tables'
...
-- ----------------------------
DROP PROCEDURE
IF EXISTS `statement_performance_analyzer`;
DELIMITER ;;
...
DECLARE v_quoted_table,
 v_quoted_custom_view VARCHAR (133) DEFAULT '' ;
DECLARE v_table_db,
 v_table_name,
 v_custom_db,
 v_custom_name VARCHAR (64) ;
DECLARE v_digest_table_template,
 v_checksum_ref,
 v_checksum_table text ;
DECLARE v_sql LONGTEXT ;
DECLARE v_error_msg VARCHAR (128) ; SELECT
	INSTRUMENTED INTO v_this_thread_enabled
FROM
	PERFORMANCE_SCHEMA .threads
WHERE
...
SET @sys.statement_performance_analyzer.
LIMIT = sys.sys_get_config (
...
SET v_table_name = SUBSTRING(
	in_table,
	CHAR_LENGTH(v_table_db) + 2
) ;
END
IF ;
SET v_quoted_table = CONCAT(
	'`',
	v_table_db,
	'`.`',
	v_table_name,
...
IF (@sys.debug = 'ON') THEN
	...
	IF (
		v_table_db = DATABASE ()
		AND (
			v_table_name = 'tmp_digests'
			OR v_table_name = 'tmp_digests_delta'
		)
	) THEN

	SET v_error_msg = CONCAT(
		'Invalid value for in_table: ',
		v_quoted_table,
		' is reserved table name.'
	) ; SIGNAL SQLSTATE '45000'
	SET MESSAGE_TEXT = v_error_msg ;
	END
	IF ; CALL sys.table_exists (
		v_table_db,
		v_table_name,
		v_table_exists
	) ;
	IF (@sys.debug = 'ON') THEN
		...
		v_checksum_table = (
			...
			FROM
				information_schema. COLUMNS
			WHERE
				TABLE_SCHEMA = v_table_db
			AND TABLE_NAME = v_table_name
		) ;
	IF (
		v_checksum_ref <> v_checksum_table
	) THEN
	...
	IF (
		CHAR_LENGTH(v_quoted_table) > 93,
		CONCAT(
			'...',
			SUBSTRING(v_quoted_table, - 90)
		),
		v_quoted_table
	),
	...
	IF (@sys.debug = 'ON') THEN
		...
		IF (
			NOT v_table_exists IN ('TEMPORARY', 'BASE TABLE')
		) THEN

		SET v_error_msg = CONCAT(
			'The ',
			in_action,
			' action requires in_table to be NULL, NOW() or specify an existing table.',
			' The table ',

		IF (
			CHAR_LENGTH(v_quoted_table) > 16,
			CONCAT(
				'...',
				SUBSTRING(v_quoted_table, - 13)
			),
			v_quoted_table
		),
		' does not exist.'
		...
		IF (
			v_table_exists NOT IN ('TEMPORARY', 'BASE TABLE')
		) THEN

		SET v_error_msg = CONCAT(
			'The ',
			in_action,
			' action requires in_table to be an existing table.',

		IF (
			in_table IS NOT NULL,
			CONCAT(
				' The table ',

			IF (
				CHAR_LENGTH(v_quoted_table) > 39,
				CONCAT(
					'...',
					SUBSTRING(v_quoted_table, - 36)
				),
				v_quoted_table
			),
			' does not exist.'
		...
		IF (
			in_action = 'delta'
			AND v_tmp_digests_table_exists <> 'TEMPORARY'
		) THEN
			SIGNAL SQLSTATE '45000'
		...
		IF (
			CHAR_LENGTH(v_quoted_table) > 72,
			CONCAT(
				'...',
				SUBSTRING(v_quoted_table, - 69)
			),
			v_quoted_table
		),
		...
		IF (
			CHAR_LENGTH(v_quoted_table) > 52,
			CONCAT(
				'...',
				SUBSTRING(v_quoted_table, - 49)
			),
			v_quoted_table
		),
		' as it already exists',
	...
	IF (
		...
		WHEN in_action = 'cleanup' THEN
			...
			IF (
				v_force_new_snapshot
				OR in_action = 'snapshot'
				OR (
					in_action = 'overall'
					AND in_table IS NULL
				)
				OR (
					in_action = 'save'
					AND v_tmp_digests_table_exists <> 'TEMPORARY'
			...
			IF (
				v_tmp_digests_table_exists = 'TEMPORARY'
			) THEN

			IF (@sys.debug = 'ON') THEN
				SELECT
					'DROP TEMPORARY TABLE IF EXISTS tmp_digests' AS 'Debug' ;
				END
				IF ; DROP TEMPORARY TABLE
				IF EXISTS tmp_digests ;
				END
				IF ; CALL sys.execute_prepared_stmt (
					REPLACE (
						REPLACE (
							v_digest_table_template,
							'%{TEMPORARY}',
							'TEMPORARY '
						),
						'%{TABLE_NAME}',
				...
				SET v_sql = CONCAT(
					'INSERT INTO tmp_digests SELECT * FROM ',
				...
				ELSEIF (in_action = 'save') THEN
					CALL sys.execute_prepared_stmt (
						...
						CONCAT(
							'INSERT INTO ',
							v_quoted_table,
							' SELECT * FROM tmp_digests'
						)
					) ;
				ELSEIF (in_action = 'cleanup') THEN
					DROP TEMPORARY TABLE
				IF EXISTS sys.tmp_digests ; DROP TEMPORARY TABLE
				IF EXISTS sys.tmp_digests_delta ;
				ELSEIF (
					in_action IN ('overall', 'delta')
				) THEN
				...
				IF (
					...
					SELECT
						'Queries with Runtime in 95th Percentile' AS 'Next Output' ; DROP TEMPORARY TABLE
					IF EXISTS tmp_digest_avg_latency_distribution1 ; DROP TEMPORARY TABLE
					IF EXISTS tmp_digest_avg_latency_distribution2 ; DROP TEMPORARY TABLE
					IF EXISTS tmp_digest_95th_percentile_by_avg_us ; CREATE TEMPORARY TABLE tmp_digest_avg_latency_distribution1 (
						cnt BIGINT UNSIGNED NOT NULL,
						avg_us DECIMAL (21, 0) NOT NULL,
						PRIMARY KEY (avg_us)
					) ENGINE = INNODB ;
					SET v_sql = CONCAT(
						'INSERT INTO tmp_digest_avg_latency_distribution1 SELECT COUNT(*) cnt,  ROUND(avg_timer_wait/1000000) AS avg_us FROM ',
						v_digests_table,
						' GROUP BY avg_us'
					) ; CALL sys.execute_prepared_stmt (v_sql) ; CREATE TEMPORARY TABLE tmp_digest_avg_latency_distribution2 LIKE tmp_digest_avg_latency_distribution1 ; INSERT INTO tmp_digest_avg_latency_distribution2 SELECT
						*
					FROM
						tmp_digest_avg_latency_distribution1 ; CREATE TEMPORARY TABLE tmp_digest_95th_percentile_by_avg_us (
							avg_us DECIMAL (21, 0) NOT NULL,
							percentile DECIMAL (46, 4) NOT NULL,
							PRIMARY KEY (avg_us)
						) ENGINE = INNODB ;
					SET v_sql = CONCAT(
						'INSERT INTO tmp_digest_95th_percentile_by_avg_us SELECT s2.avg_us avg_us, IFNULL(SUM(s1.cnt)/NULLIF((SELECT COUNT(*) FROM ',
						v_digests_table,
						'), 0), 0) percentile FROM tmp_digest_avg_latency_distribution1 AS s1 JOIN tmp_digest_avg_latency_distribution2 AS s2 ON s1.avg_us <= s2.avg_us GROUP BY s2.avg_us HAVING percentile > 0.95 ORDER BY percentile LIMIT 1'
					) ; CALL sys.execute_prepared_stmt (v_sql) ;
					SET v_sql = REPLACE (
						REPLACE (
							(
								...
								AND TABLE_NAME = 'statements_with_runtimes_in_95th_percentile'
							),
							'`performance_schema`.`events_statements_summary_by_digest`',
							v_digests_table
						),
						...
						'`sys`.`x$ps_digest_95th_percentile_by_avg_us`'
					) ; CALL sys.execute_prepared_stmt (v_sql) ; DROP TEMPORARY TABLE tmp_digest_avg_latency_distribution1 ; DROP TEMPORARY TABLE tmp_digest_avg_latency_distribution2 ; DROP TEMPORARY TABLE tmp_digest_95th_percentile_by_avg_us ;
					END
					IF ;
					IF (
						FIND_IN_SET('analysis', in_views)
					) THEN
						SELECT
							CONCAT(
								'Top ',
								@sys.statement_performance_analyzer.
							LIMIT,
							' Queries Ordered by Total Latency'
							) AS 'Next Output' ;
						SET v_sql = REPLACE (
							(
								SELECT
								...
								WHERE
									TABLE_SCHEMA = DATABASE ()
								AND TABLE_NAME = 'statement_analysis'
							),
							'`performance_schema`.`events_statements_summary_by_digest`',
							v_digests_table
						) ;
						...
						END
						IF ; CALL sys.execute_prepared_stmt (v_sql) ;
						END
						IF ;
						IF (
							FIND_IN_SET(
							...
							SET v_sql = REPLACE (
								(
									...
									WHERE
										TABLE_SCHEMA = DATABASE ()
									AND TABLE_NAME = 'statements_with_errors_or_warnings'
								),
								'`performance_schema`.`events_statements_summary_by_digest`',
								v_digests_table
							) ;
							...
							IF (
								...
								SET v_sql = REPLACE (
									(
										...
										WHERE
											TABLE_SCHEMA = DATABASE ()
										AND TABLE_NAME = 'statements_with_full_table_scans'
									),
									'`performance_schema`.`events_statements_summary_by_digest`',
									v_digests_table
								) ;
								...
								IF ;
								IF (
									FIND_IN_SET('with_sorting', in_views)
								) THEN
									SELECT
										CONCAT(
											'Top ',
									...
									SET v_sql = REPLACE (
										(
											...
											WHERE
												TABLE_SCHEMA = DATABASE ()
											AND TABLE_NAME = 'statements_with_sorting'
										),
										'`performance_schema`.`events_statements_summary_by_digest`',
										v_digests_table
									) ;
									...
									IF (
										...
										SELECT
											CONCAT(
												...
												@sys.statement_performance_analyzer.
											LIMIT,
											' Queries with Internal Temporary Tables'
											) AS 'Next Output' ;
										SET v_sql = REPLACE (
											(
												SELECT
												...
												WHERE
													TABLE_SCHEMA = DATABASE ()
												AND TABLE_NAME = 'statements_with_temp_tables'
											),
											'`performance_schema`.`events_statements_summary_by_digest`',
											v_digests_table
										) ;
										...
										IF (
											...
											SELECT
												CONCAT(
													...
													@sys.statement_performance_analyzer.
												LIMIT,
												' Queries Using Custom View'
												) AS 'Next Output' ;
											IF (
												@sys.statement_performance_analyzer. VIEW IS NULL
											) THEN

											SET @sys.statement_performance_analyzer. VIEW = sys.sys_get_config (
										...
										SET v_custom_db = SUBSTRING_INDEX(
											@sys.statement_performance_analyzer. VIEW,
											'.',
											1
										) ;
										SET v_custom_name = SUBSTRING(
											@sys.statement_performance_analyzer. VIEW,
											CHAR_LENGTH(v_custom_db) + 2
										) ;
										END
										IF ; CALL sys.table_exists (
											v_custom_db,
											v_custom_name,
											v_custom_view_exists
										) ;
										IF (
											v_custom_view_exists <> 'VIEW'
										) THEN
											SIGNAL SQLSTATE '45000'
										...
										SET v_sql = REPLACE (
											(
												...
												FROM
													information_schema.VIEWS
												WHERE
													TABLE_SCHEMA = v_custom_db
												AND TABLE_NAME = v_custom_name
											),
											'`performance_schema`.`events_statements_summary_by_digest`',
											v_digests_table
										) ;
...
SET @sys.tmp.table_exists. SQL = CONCAT(
	'CREATE TEMPORARY TABLE `',
	in_db,
	'`.`',
	in_table,
	'` (id INT PRIMARY KEY)'
) ; PREPARE stmt_create_table
FROM
	@sys.tmp.table_exists. SQL ; EXECUTE stmt_create_table ; DEALLOCATE PREPARE stmt_create_table ;
IF (v_error) THEN
...
SET @sys.tmp.table_exists. SQL = CONCAT(
	...
	in_table,
	'`'
) ; PREPARE stmt_drop_table
FROM
	@sys.tmp.table_exists. SQL ; EXECUTE stmt_drop_table ; DEALLOCATE PREPARE stmt_drop_table ;
SET out_exists = (
	SELECT
		TABLE_TYPE
	FROM
...
-- ----------------------------
DROP FUNCTION
IF EXISTS `extract_schema_from_file_name`;
DELIMITER ;;


CREATE  FUNCTION `extract_schema_from_file_name` (path VARCHAR(512)) RETURNS VARCHAR (64) CHARSET utf8 NO SQL DETERMINISTIC SQL SECURITY INVOKER COMMENT '\n Description\n \n Takes a raw file path, and attempts to extract the schema name from it.\n \n Useful for when interacting with Performance Schema data \n concerning IO statistics, for example.\n \n Currently relies on the fact that a table data file will be within a \n specified database directory (will not work with partitions or tables\n that specify an individual DATA_DIRECTORY).\n \n Parameters\n \n path (VARCHAR(512)):\n The full file path to a data file to extract the schema name from.\n \n Returns\n \n VARCHAR(64)\n \n Example\n \n mysql> SELECT sys.extract_schema_from_file_name(''/var/lib/mysql/employees/employee.ibd'');\n +----------------------------------------------------------------------------+\n | sys.extract_schema_from_file_name(''/var/lib/mysql/employees/employee.ibd'') |\n +----------------------------------------------------------------------------+\n | employees                                                                  |\n +----------------------------------------------------------------------------+\n 1 row in set (0.00 sec)\n '
BEGIN
	RETURN LEFT (
		SUBSTRING_INDEX(
			SUBSTRING_INDEX(
...
-- ----------------------------
DROP FUNCTION
IF EXISTS `extract_table_from_file_name`;
DELIMITER ;;


CREATE  FUNCTION `extract_table_from_file_name` (path VARCHAR(512)) RETURNS VARCHAR (64) CHARSET utf8 NO SQL DETERMINISTIC SQL SECURITY INVOKER COMMENT '\n Description\n \n Takes a raw file path, and extracts the table name from it.\n \n Useful for when interacting with Performance Schema data \n concerning IO statistics, for example.\n \n Parameters\n \n path (VARCHAR(512)):\n The full file path to a data file to extract the table name from.\n \n Returns\n \n VARCHAR(64)\n \n Example\n \n mysql> SELECT sys.extract_table_from_file_name(''/var/lib/mysql/employees/employee.ibd'');\n +---------------------------------------------------------------------------+\n | sys.extract_table_from_file_name(''/var/lib/mysql/employees/employee.ibd'') |\n +---------------------------------------------------------------------------+\n | employee                                                                  |\n +---------------------------------------------------------------------------+\n 1 row in set (0.02 sec)\n '
BEGIN
	RETURN LEFT (
		SUBSTRING_INDEX(
			REPLACE (
...
-- ----------------------------
DROP FUNCTION
IF EXISTS `format_bytes`;
DELIMITER ;;


CREATE  FUNCTION `format_bytes` (bytes TEXT) RETURNS text CHARSET utf8 NO SQL DETERMINISTIC SQL SECURITY INVOKER COMMENT '\n Description\n \n Takes a raw bytes value, and converts it to a human readable format.\n \n Parameters\n \n bytes (TEXT):\n A raw bytes value.\n \n Returns\n \n TEXT\n \n Example\n \n mysql> SELECT sys.format_bytes(2348723492723746) AS size;\n +----------+\n | size     |\n +----------+\n | 2.09 PiB |\n +----------+\n 1 row in set (0.00 sec)\n \n mysql> SELECT sys.format_bytes(2348723492723) AS size;\n +----------+\n | size     |\n +----------+\n | 2.14 TiB |\n +----------+\n 1 row in set (0.00 sec)\n \n mysql> SELECT sys.format_bytes(23487234) AS size;\n +-----------+\n | size      |\n +-----------+\n | 22.40 MiB |\n +-----------+\n 1 row in set (0.00 sec)\n '
BEGIN
...
ELSEIF bytes >= 1125899906842624 THEN
	RETURN CONCAT(
		ROUND(bytes / 1125899906842624, 2),
		' PiB'
	) ;
ELSEIF bytes >= 1099511627776 THEN
	RETURN CONCAT(
		ROUND(bytes / 1099511627776, 2),
		' TiB'
	) ;
ELSEIF bytes >= 1073741824 THEN
	RETURN CONCAT(
		ROUND(bytes / 1073741824, 2),
		' GiB'
	) ;
...
CREATE  FUNCTION `format_path` (in_path VARCHAR(512)) RETURNS VARCHAR (512) CHARSET utf8 NO SQL DETERMINISTIC SQL SECURITY INVOKER COMMENT '\n Description\n \n Takes a raw path value, and strips out the datadir or tmpdir\n replacing with @@datadir and @@tmpdir respectively. \n \n Also normalizes the paths across operating systems, so backslashes\n on Windows are converted to forward slashes\n \n Parameters\n \n path (VARCHAR(512)):\n The raw file path value to format.\n \n Returns\n \n VARCHAR(512) CHARSET UTF8\n \n Example\n \n mysql> select @@datadir;\n +-----------------------------------------------+\n | @@datadir                                     |\n +-----------------------------------------------+\n | /Users/mark/sandboxes/SmallTree/AMaster/data/ |\n +-----------------------------------------------+\n 1 row in set (0.06 sec)\n \n mysql> select format_path(''/Users/mark/sandboxes/SmallTree/AMaster/data/mysql/proc.MYD'') AS path;\n +--------------------------+\n | path                     |\n +--------------------------+\n | @@datadir/mysql/proc.MYD |\n +--------------------------+\n 1 row in set (0.03 sec)\n '
BEGIN
...
IF v_path IS NULL THEN
	RETURN NULL ;
ELSEIF v_path LIKE CONCAT(
	@@GLOBAL .datadir,

IF (
	SUBSTRING(@@GLOBAL .datadir, - 1) = path_separator,
	'%',
...
IF (
	SUBSTRING(@@GLOBAL .tmpdir, - 1) = path_separator,
	'%',
	CONCAT(path_separator, '%')
)
) ESCAPE '|' THEN
...
IF (
	SUBSTRING(v_undo_dir, - 1) = path_separator,
	'%',
	CONCAT(path_separator, '%')
)
) ESCAPE '|' THEN
...
IF (
	SUBSTRING(@@GLOBAL .basedir, - 1) = path_separator,
	'%',
	CONCAT(path_separator, '%')
)
) ESCAPE '|' THEN
...
-- ----------------------------
DROP FUNCTION
IF EXISTS `format_statement`;
DELIMITER ;;


CREATE  FUNCTION `format_statement` (statement LONGTEXT) RETURNS LONGTEXT CHARSET utf8 NO SQL DETERMINISTIC SQL SECURITY INVOKER COMMENT '\n Description\n \n Formats a normalized statement, truncating it if it is > 64 characters long by default.\n \n To configure the length to truncate the statement to by default, update the `statement_truncate_len`\n variable with `sys_config` table to a different value. Alternatively, to change it just for just \n your particular session, use `SET @sys.statement_truncate_len := <some new value>`.\n \n Useful for printing statement related data from Performance Schema from \n the command line.\n \n Parameters\n \n statement (LONGTEXT): \n The statement to format.\n \n Returns\n \n LONGTEXT\n \n Example\n \n mysql> SELECT sys.format_statement(digest_text)\n ->   FROM performance_schema.events_statements_summary_by_digest\n ->  ORDER by sum_timer_wait DESC limit 5;\n +-------------------------------------------------------------------+\n | sys.format_statement(digest_text)                                 |\n +-------------------------------------------------------------------+\n | CREATE SQL SECURITY INVOKER VI ... KE ? AND `variable_value` > ?  |\n | CREATE SQL SECURITY INVOKER VI ... ait` IS NOT NULL , `esc` . ... |\n | CREATE SQL SECURITY INVOKER VI ... ait` IS NOT NULL , `sys` . ... |\n | CREATE SQL SECURITY INVOKER VI ...  , `compressed_size` ) ) DESC  |\n | CREATE SQL SECURITY INVOKER VI ... LIKE ? ORDER BY `timer_start`  |\n +-------------------------------------------------------------------+\n 5 rows in set (0.00 sec)\n '
BEGIN

IF @sys.statement_truncate_len IS NULL THEN

SET @sys.statement_truncate_len = sys_get_config (
	'statement_truncate_len',
	64
) ;
END
...
-- ----------------------------
DROP FUNCTION
IF EXISTS `format_time`;
DELIMITER ;;


CREATE  FUNCTION `format_time` (picoseconds TEXT) RETURNS text CHARSET utf8 NO SQL DETERMINISTIC SQL SECURITY INVOKER COMMENT '\n Description\n \n Takes a raw picoseconds value, and converts it to a human readable form.\n \n Picoseconds are the precision that all latency values are printed in \n within Performance Schema, however are not user friendly when wanting\n to scan output from the command line.\n \n Parameters\n \n picoseconds (TEXT): \n The raw picoseconds value to convert.\n \n Returns\n \n TEXT\n \n Example\n \n mysql> select format_time(342342342342345);\n +------------------------------+\n | format_time(342342342342345) |\n +------------------------------+\n | 00:05:42                     |\n +------------------------------+\n 1 row in set (0.00 sec)\n \n mysql> select format_time(342342342);\n +------------------------+\n | format_time(342342342) |\n +------------------------+\n | 342.34 us              |\n +------------------------+\n 1 row in set (0.00 sec)\n \n mysql> select format_time(34234);\n +--------------------+\n | format_time(34234) |\n +--------------------+\n | 34.23 ns           |\n +--------------------+\n 1 row in set (0.00 sec)\n '
BEGIN
...
ELSEIF picoseconds >= 604800000000000000 THEN
	RETURN CONCAT(
		ROUND(
			picoseconds / 604800000000000000,
			2
		),
		' w'
	) ;
...
ELSEIF picoseconds >= 1000000000 THEN
	RETURN CONCAT(
		ROUND(picoseconds / 1000000000, 2),
		' ms'
	) ;
ELSEIF picoseconds >= 1000000 THEN
	RETURN CONCAT(
		ROUND(picoseconds / 1000000, 2),
		' us'
	) ;
ELSEIF picoseconds >= 1000 THEN
	RETURN CONCAT(
		ROUND(picoseconds / 1000, 2),
		' ns'
	) ;
ELSE
...
-- ----------------------------
DROP FUNCTION
IF EXISTS `ps_is_account_enabled`;
DELIMITER ;;
...
CREATE  FUNCTION `ps_is_account_enabled` (
	in_host VARCHAR (60),
	in_user VARCHAR (32)
) RETURNS enum ('YES', 'NO') CHARSET utf8 READS SQL DATA DETERMINISTIC SQL SECURITY INVOKER COMMENT '\n Description\n \n Determines whether instrumentation of an account is enabled \n within Performance Schema.\n \n Parameters\n \n in_host VARCHAR(60): \n The hostname of the account to check.\n in_user VARCHAR(32):\n The username of the account to check.\n \n Returns\n \n ENUM(''YES'', ''NO'', ''PARTIAL'')\n \n Example\n \n mysql> SELECT sys.ps_is_account_enabled(''localhost'', ''root'');\n +------------------------------------------------+\n | sys.ps_is_account_enabled(''localhost'', ''root'') |\n +------------------------------------------------+\n | YES                                            |\n +------------------------------------------------+\n 1 row in set (0.01 sec)\n '
BEGIN
	RETURN
IF (
	EXISTS (
...
-- ----------------------------
DROP FUNCTION
IF EXISTS `ps_is_consumer_enabled`;
DELIMITER ;;


CREATE  FUNCTION `ps_is_consumer_enabled` (in_consumer VARCHAR(64)) RETURNS enum ('YES', 'NO') CHARSET utf8 READS SQL DATA DETERMINISTIC SQL SECURITY INVOKER COMMENT '\n Description\n \n Determines whether a consumer is enabled (taking the consumer hierarchy into consideration)\n within the Performance Schema.\n \n Parameters\n \n in_consumer VARCHAR(64): \n The name of the consumer to check.\n \n Returns\n \n ENUM(''YES'', ''NO'')\n \n Example\n \n mysql> SELECT sys.ps_is_consumer_enabled(''events_stages_history'');\n +-----------------------------------------------------+\n | sys.ps_is_consumer_enabled(''events_stages_history'') |\n +-----------------------------------------------------+\n | NO                                                  |\n +-----------------------------------------------------+\n 1 row in set (0.00 sec)\n '
BEGIN
	RETURN (
		SELECT
			(
				CASE
				WHEN c. NAME = 'global_instrumentation' THEN
					c.ENABLED
				WHEN c. NAME = 'thread_instrumentation' THEN
				...
				WHEN c. NAME LIKE '%\_current' THEN
				...
				IF (
					...
					AND (
						SELECT
							cc.ENABLED
						FROM
							PERFORMANCE_SCHEMA .setup_consumers cc
						WHERE
							NAME = CONCAT(
								SUBSTRING_INDEX(c. NAME, '_', 2),
								'_current'
							)
					) = 'YES',
					'YES',
		...
		WHERE
			cg. NAME = 'global_instrumentation'
...
-- ----------------------------
DROP FUNCTION
IF EXISTS `ps_is_instrument_default_enabled`;
DELIMITER ;;


CREATE  FUNCTION `ps_is_instrument_default_enabled` (in_instrument VARCHAR(128)) RETURNS enum ('YES', 'NO') CHARSET utf8 READS SQL DATA DETERMINISTIC SQL SECURITY INVOKER COMMENT '\n Description\n \n Returns whether an instrument is enabled by default in this version of MySQL.\n \n Parameters\n \n in_instrument VARCHAR(128): \n The instrument to check.\n \n Returns\n \n ENUM(''YES'', ''NO'')\n \n Example\n \n mysql> SELECT sys.ps_is_instrument_default_enabled(''statement/sql/select'');\n +--------------------------------------------------------------+\n | sys.ps_is_instrument_default_enabled(''statement/sql/select'') |\n +--------------------------------------------------------------+\n | YES                                                          |\n +--------------------------------------------------------------+\n 1 row in set (0.00 sec)\n '
BEGIN

DECLARE v_enabled ENUM ('YES', 'NO') ;
SET v_enabled =
IF (
	in_instrument LIKE 'wait/io/file/%'
...
-- ----------------------------
DROP FUNCTION
IF EXISTS `ps_is_instrument_default_timed`;
DELIMITER ;;


CREATE  FUNCTION `ps_is_instrument_default_timed` (in_instrument VARCHAR(128)) RETURNS enum ('YES', 'NO') CHARSET utf8 READS SQL DATA DETERMINISTIC SQL SECURITY INVOKER COMMENT '\n Description\n \n Returns whether an instrument is timed by default in this version of MySQL.\n \n Parameters\n \n in_instrument VARCHAR(128): \n The instrument to check.\n \n Returns\n \n ENUM(''YES'', ''NO'')\n \n Example\n \n mysql> SELECT sys.ps_is_instrument_default_timed(''statement/sql/select'');\n +------------------------------------------------------------+\n | sys.ps_is_instrument_default_timed(''statement/sql/select'') |\n +------------------------------------------------------------+\n | YES                                                        |\n +------------------------------------------------------------+\n 1 row in set (0.00 sec)\n '
BEGIN
...
-- ----------------------------
DROP FUNCTION
IF EXISTS `ps_is_thread_instrumented`;
DELIMITER ;;


CREATE  FUNCTION `ps_is_thread_instrumented` (
	in_connection_id BIGINT UNSIGNED
) RETURNS enum ('YES', 'NO', 'UNKNOWN') CHARSET utf8 READS SQL DATA SQL SECURITY INVOKER COMMENT '\n Description\n \n Checks whether the provided connection id is instrumented within Performance Schema.\n \n Parameters\n \n in_connection_id (BIGINT UNSIGNED):\n The id of the connection to check.\n \n Returns\n \n ENUM(''YES'', ''NO'', ''UNKNOWN'')\n \n Example\n \n mysql> SELECT sys.ps_is_thread_instrumented(CONNECTION_ID());\n +------------------------------------------------+\n | sys.ps_is_thread_instrumented(CONNECTION_ID()) |\n +------------------------------------------------+\n | YES                                            |\n +------------------------------------------------+\n '
BEGIN
...
FROM
	PERFORMANCE_SCHEMA .threads
WHERE
	PROCESSLIST_ID = in_connection_id ;
...
-- ----------------------------
DROP FUNCTION
IF EXISTS `ps_thread_account`;
DELIMITER ;;


CREATE  FUNCTION `ps_thread_account` (in_thread_id BIGINT UNSIGNED) RETURNS text CHARSET utf8 READS SQL DATA SQL SECURITY INVOKER COMMENT '\n Description\n \n Return the user@host account for the given Performance Schema thread id.\n \n Parameters\n \n in_thread_id (BIGINT UNSIGNED):\n The id of the thread to return the account for.\n \n Example\n \n mysql> select thread_id, processlist_user, processlist_host from performance_schema.threads where type = ''foreground'';\n +-----------+------------------+------------------+\n | thread_id | processlist_user | processlist_host |\n +-----------+------------------+------------------+\n |        23 | NULL             | NULL             |\n |        30 | root             | localhost        |\n |        31 | msandbox         | localhost        |\n |        32 | msandbox         | localhost        |\n +-----------+------------------+------------------+\n 4 rows in set (0.00 sec)\n \n mysql> select sys.ps_thread_account(31);\n +---------------------------+\n | sys.ps_thread_account(31) |\n +---------------------------+\n | msandbox@localhost        |\n +---------------------------+\n 1 row in set (0.00 sec)\n '
BEGIN
	RETURN (
		SELECT
...
-- ----------------------------
DROP FUNCTION
IF EXISTS `ps_thread_id`;
DELIMITER ;;


CREATE  FUNCTION `ps_thread_id` (
	in_connection_id BIGINT UNSIGNED
) RETURNS BIGINT (20) UNSIGNED READS SQL DATA SQL SECURITY INVOKER COMMENT '\n Description\n \n Return the Performance Schema THREAD_ID for the specified connection ID.\n \n Parameters\n \n in_connection_id (BIGINT UNSIGNED):\n The id of the connection to return the thread id for. If NULL, the current\n connection thread id is returned.\n \n Example\n \n mysql> SELECT sys.ps_thread_id(79);\n +----------------------+\n | sys.ps_thread_id(79) |\n +----------------------+\n |                   98 |\n +----------------------+\n 1 row in set (0.00 sec)\n \n mysql> SELECT sys.ps_thread_id(CONNECTION_ID());\n +-----------------------------------+\n | sys.ps_thread_id(CONNECTION_ID()) |\n +-----------------------------------+\n |                                98 |\n +-----------------------------------+\n 1 row in set (0.00 sec)\n '
BEGIN
	RETURN (
		SELECT
			THREAD_ID
...
CREATE  FUNCTION `ps_thread_stack` (
	...
	debug BOOLEAN
) RETURNS LONGTEXT CHARSET latin1 READS SQL DATA SQL SECURITY INVOKER COMMENT '\n Description\n \n Outputs a JSON formatted stack of all statements, stages and events\n within Performance Schema for the specified thread.\n \n Parameters\n \n thd_id (BIGINT UNSIGNED):\n The id of the thread to trace. This should match the thread_id\n column from the performance_schema.threads table.\n in_verbose (BOOLEAN):\n Include file:lineno information in the events.\n \n Example\n \n (line separation added for output)\n \n mysql> SELECT sys.ps_thread_stack(37, FALSE) AS thread_stack\\G\n *************************** 1. row ***************************\n thread_stack: {"rankdir": "LR","nodesep": "0.10","stack_created": "2014-02-19 13:39:03",\n "mysql_version": "5.7.3-m13","mysql_user": "root@localhost","events": \n [{"nesting_event_id": "0", "event_id": "10", "timer_wait": 256.35, "event_info": \n "sql/select", "wait_info": "select @@version_comment limit 1\\nerrors: 0\\nwarnings: 0\\nlock time:\n ...\n '
BEGIN

DECLARE json_objects LONGTEXT ; UPDATE PERFORMANCE_SCHEMA .threads
SET instrumented = 'NO'
WHERE
	processlist_id = CONNECTION_ID() ;
SET SESSION group_concat_max_len =@@GLOBAL .max_allowed_packet ; SELECT
	GROUP_CONCAT(
		CONCAT(
			'{',
			CONCAT_WS(
				...
				CONCAT(
					'"timer_wait": ',
					ROUND(timer_wait / 1000000, 2)
				),
				CONCAT(
					'"event_info": "',
					CASE
				WHEN event_name NOT LIKE 'wait/io%' THEN
					REPLACE (
						SUBSTRING_INDEX(event_name, '/', - 2),
						'\\',
						'\\\\'
					)
				WHEN event_name NOT LIKE 'wait/io/file%'
				OR event_name NOT LIKE 'wait/io/socket%' THEN
					REPLACE (
						SUBSTRING_INDEX(event_name, '/', - 4),
						'\\',
						'\\\\'
			...
			WHEN event_name LIKE 'wait/io/table%' THEN
				'"event_type": "io/table"'
			WHEN event_name LIKE 'wait/io/socket%' THEN
				'"event_type": "io/socket"'
			WHEN event_name LIKE 'wait/synch/mutex%' THEN
				'"event_type": "synch/mutex"'
			WHEN event_name LIKE 'wait/synch/cond%' THEN
				'"event_type": "synch/cond"'
			WHEN event_name LIKE 'wait/synch/rwlock%' THEN
				'"event_type": "synch/rwlock"'
			WHEN event_name LIKE 'wait/lock%' THEN
				'"event_type": "lock"'
			WHEN event_name LIKE 'statement/%' THEN
				'"event_type": "stmt"'
		...
		ORDER BY
			event_id ASC SEPARATOR ','
	) EVENT INTO json_objects
FROM
	(
		(
			SELECT
...
DECLARE EXIT HANDLER FOR SQLWARNING,
 SQLEXCEPTION
BEGIN
	GET DIAGNOSTICS CONDITION 1 v_msg_text = MESSAGE_TEXT,
	v_mysql_errno = MYSQL_ERRNO ;
IF v_mysql_errno = 1260 THEN

SET v_signal_msg = CONCAT(
	'{ "error": "Trx info truncated: ',
	v_msg_text,
	'" }'
) ;
ELSE
...
END
IF ; RETURN v_signal_msg ;
END ;
IF (
	@sys.ps_thread_trx_info.max_length IS NULL
) THEN

SET @sys.ps_thread_trx_info.max_length = sys.sys_get_config (
...
IF ;
IF (
	@sys.ps_thread_trx_info.max_length != @@SESSION .group_concat_max_len
) THEN

SET @old_group_concat_max_len = @@SESSION .group_concat_max_len ;
SET v_max_output_len = (
	@sys.ps_thread_trx_info.max_length - 5
) ;
...
SET v_output = (
	SELECT
		CONCAT(
			'[',
			IFNULL(
				GROUP_CONCAT(trx_info ORDER BY event_id),
				''
			),
			'\n]'
		) AS trx_info
		...
		(
				...
				GROUP_CONCAT(
					IFNULL(
						CONCAT(
							...
							'    "time": "',
							IFNULL(
								sys.format_time (trxi.timer_wait),
								''
							),
							'",\n',
							'    "state": "',
							...
							'",\n',
							'    "mode": "',
							IFNULL(trxi.access_mode, ''),
							'",\n',
							'    "autocommitted": "',
							IFNULL(trxi.autocommit, ''),
							'",\n',
							'    "gtid": "',
							IFNULL(trxi.gtid, ''),
							'",\n',
							'    "isolation": "',
							IFNULL(trxi.isolation_level, ''),
							'",\n',
							'    "statements_executed": [',
							IFNULL(s.stmts, ''),
			...
			LEFT JOIN (
					...
					GROUP_CONCAT(
						IFNULL(
							CONCAT(
								...
								'",\n',
								'        "rows_examined": ',
								IFNULL(rows_examined, ''),
								',\n',
								'        "rows_affected": ',
								IFNULL(rows_affected, ''),
								',\n',
								'        "rows_sent": ',
								IFNULL(rows_sent, ''),
								',\n',
								'        "tmp_tables": ',
								IFNULL(created_tmp_tables, ''),
								',\n',
								'        "tmp_disk_tables": ',
								IFNULL(created_tmp_disk_tables, ''),
								',\n',
								'        "sort_rows": ',
								IFNULL(sort_rows, ''),
								',\n',
								'        "sort_merge_passes": ',
								IFNULL(sort_merge_passes, ''),
								'\n',
								'      }'
							),
							''
				...
				GROUP BY
					thread_id,
					nesting_event_id
			) AS s ON trxi.thread_id = s.thread_id
			AND trxi.event_id = s.nesting_event_id
			WHERE
				trxi.thread_id = in_thread_id
			GROUP BY
				trxi.thread_id,
				trxi.event_id
		) trxs
...
IF (
	@old_group_concat_max_len IS NOT NULL
) THEN
...
-- ----------------------------
DROP FUNCTION
IF EXISTS `quote_identifier`;
DELIMITER ;;


CREATE  FUNCTION `quote_identifier` (in_identifier TEXT) RETURNS text CHARSET utf8 NO SQL DETERMINISTIC SQL SECURITY INVOKER COMMENT '\n Description\n \n Takes an unquoted identifier (schema name, table name, etc.) and\n returns the identifier quoted with backticks.\n \n Parameters\n \n in_identifier (TEXT):\n The identifier to quote.\n \n Returns\n \n TEXT\n \n Example\n \n mysql> SELECT sys.quote_identifier(''my_identifier'') AS Identifier;\n +-----------------+\n | Identifier      |\n +-----------------+\n | `my_identifier` |\n +-----------------+\n 1 row in set (0.00 sec)\n \n mysql> SELECT sys.quote_identifier(''my`idenfier'') AS Identifier;\n +----------------+\n | Identifier     |\n +----------------+\n | `my``idenfier` |\n +----------------+\n 1 row in set (0.00 sec)\n '
BEGIN
	RETURN CONCAT(
		'`',
		REPLACE (in_identifier, '`', '``'),
		'`'
	) ;
END;;
DELIMITER ;
...
-- ----------------------------
DROP FUNCTION
IF EXISTS `version_major`;
DELIMITER ;;


CREATE  FUNCTION `version_major` () RETURNS TINYINT (3) UNSIGNED NO SQL SQL SECURITY INVOKER COMMENT '\n Description\n \n Returns the major version of MySQL Server.\n \n Returns\n \n TINYINT UNSIGNED\n \n Example\n \n mysql> SELECT VERSION(), sys.version_major();\n +--------------------------------------+---------------------+\n | VERSION()                            | sys.version_major() |\n +--------------------------------------+---------------------+\n | 5.7.9-enterprise-commercial-advanced | 5                   |\n +--------------------------------------+---------------------+\n 1 row in set (0.00 sec)\n '
BEGIN
...
-- ----------------------------
DROP FUNCTION
IF EXISTS `version_minor`;
DELIMITER ;;


CREATE  FUNCTION `version_minor` () RETURNS TINYINT (3) UNSIGNED NO SQL SQL SECURITY INVOKER COMMENT '\n Description\n \n Returns the minor (release series) version of MySQL Server.\n \n Returns\n \n TINYINT UNSIGNED\n \n Example\n \n mysql> SELECT VERSION(), sys.server_minor();\n +--------------------------------------+---------------------+\n | VERSION()                            | sys.version_minor() |\n +--------------------------------------+---------------------+\n | 5.7.9-enterprise-commercial-advanced | 7                   |\n +--------------------------------------+---------------------+\n 1 row in set (0.00 sec)\n '
BEGIN
	RETURN SUBSTRING_INDEX(
		SUBSTRING_INDEX(
			SUBSTRING_INDEX(VERSION(), '-', 1),
...
-- ----------------------------
DROP FUNCTION
IF EXISTS `version_patch`;
DELIMITER ;;


CREATE  FUNCTION `version_patch` () RETURNS TINYINT (3) UNSIGNED NO SQL SQL SECURITY INVOKER COMMENT '\n Description\n \n Returns the patch release version of MySQL Server.\n \n Returns\n \n TINYINT UNSIGNED\n \n Example\n \n mysql> SELECT VERSION(), sys.version_patch();\n +--------------------------------------+---------------------+\n | VERSION()                            | sys.version_patch() |\n +--------------------------------------+---------------------+\n | 5.7.9-enterprise-commercial-advanced | 9                   |\n +--------------------------------------+---------------------+\n 1 row in set (0.00 sec)\n '
BEGIN
	RETURN SUBSTRING_INDEX(
		SUBSTRING_INDEX(VERSION(), '-', 1),
		'.',
...
DROP TRIGGER
IF EXISTS `sys_config_insert_set_user`;
DELIMITER ;;
...
IF @sys.ignore_sys_config_triggers != TRUE
...
DROP TRIGGER
IF EXISTS `sys_config_update_set_user`;
DELIMITER ;;
